...
Функция ПолучитьИнформациюТранспортныхНакладных(ДокументСсылка) Экспорт 
	...
	Если КоличествоТранспортныхНакладных = 1 Тогда
		...
		Пока ВыборкаСсылка.Следующий() Цикл
			...
			СокращенноеНаименованиеТранспортнойНакладной = ОбщегоНазначенияУТКлиентСервер.СформироватьЗаголовокДокумента(СтруктураШапки, , Локализация.КодЯзыкаИнтерфейса());
		КонецЦикла;
	КонецЕсли;
...
Функция РеквизитыТранспортнойНакладной(МассивРаспоряжений = Неопределено, ЗаданиеНаПеревозку = Неопределено, ЗначенияЗаполнения = Неопределено) Экспорт
	...
	ДанныеЗаполнения.Вставить("АвтомобильДлина");
	ДанныеЗаполнения.Вставить("АвтомобильВысота");
	ДанныеЗаполнения.Вставить("АвтомобильШирина");
	ДанныеЗаполнения.Вставить("АвтомобильОбщаяМасса"); 
	ДанныеЗаполнения.Вставить("АвтомобильМасса"); 
	ДанныеЗаполнения.Вставить("МестоХраненияАвтомобиля"); 
	ДанныеЗаполнения.Вставить("МестоХраненияАвтомобиляЗначенияПолей"); 
	ДанныеЗаполнения.Вставить("МестоСоставленияДокумента"); 
	...
	ДанныеЗаполнения.Вставить("ДолжностьВодителя");
...
Функция УстановитьСписокВыбораФИОВодителей(Элемент, Грузоотправители = Неопределено, ЗаданиеНаПеревозку = Неопределено) Экспорт 
	...
	|	Водители.ДолжностьВодителя КАК ДолжностьВодителя,
	...
	|		ЗаданиеНаПеревозкуРаспоряжения.Ссылка.ДолжностьВодителя,
	...
	Пока РезультатЗапроса.Следующий() Цикл                                                 
		ИнформацияВодителя = Новый Структура("Водитель, УдостоверениеСерия, УдостоверениеНомер, ДолжностьВодителя");
...
Функция УстановитьСписокВыбораТранспортныхСредств(Элемент, Грузоотправители = Неопределено, ЗаданиеНаПеревозку = Неопределено) Экспорт 
	...
	|	ТранспортныеСредства.АвтомобильДлина,
	|	ТранспортныеСредства.АвтомобильШирина,
	|	ТранспортныеСредства.АвтомобильВысота,
	|	ТранспортныеСредства.АвтомобильМасса,
	|	ТранспортныеСредства.МестоХраненияАвтомобиля,
	|	ТранспортныеСредства.МестоХраненияАвтомобиляЗначенияПолей,
	...
	|		ЗаданиеНаПеревозкуРаспоряжения.Ссылка.АвтомобильДлина КАК АвтомобильДлина,
	|		ЗаданиеНаПеревозкуРаспоряжения.Ссылка.АвтомобильШирина КАК АвтомобильШирина,
	|		ЗаданиеНаПеревозкуРаспоряжения.Ссылка.АвтомобильВысота КАК АвтомобильВысота,
	|		ЗаданиеНаПеревозкуРаспоряжения.Ссылка.АвтомобильМасса КАК АвтомобильМасса,
	|		ЗаданиеНаПеревозкуРаспоряжения.Ссылка.МестоХраненияАвтомобиля КАК МестоХраненияАвтомобиля,
	|		ВЫРАЗИТЬ(ЗаданиеНаПеревозкуРаспоряжения.Ссылка.МестоХраненияАвтомобиляЗначенияПолей КАК СТРОКА(1024)) КАК МестоХраненияАвтомобиляЗначенияПолей,
	...
	|		ЗаданиеНаПеревозкуРаспоряжения.Ссылка.АвтомобильДлина,
	|		ЗаданиеНаПеревозкуРаспоряжения.Ссылка.АвтомобильШирина,
	|		ЗаданиеНаПеревозкуРаспоряжения.Ссылка.АвтомобильВысота,
	|		ЗаданиеНаПеревозкуРаспоряжения.Ссылка.АвтомобильМасса,
	|		ЗаданиеНаПеревозкуРаспоряжения.Ссылка.МестоХраненияАвтомобиля,
	|		ВЫРАЗИТЬ(ЗаданиеНаПеревозкуРаспоряжения.Ссылка.МестоХраненияАвтомобиляЗначенияПолей КАК СТРОКА(1024)),
	...
	|		ТранспортнаяНакладная.МестоХраненияАвтомобиля,
	|		ВЫРАЗИТЬ(ТранспортнаяНакладная.МестоХраненияАвтомобиляЗначенияПолей КАК СТРОКА(1024)) КАК МестоХраненияАвтомобиляЗначенияПолей,
	|
	...
	|		ТранспортнаяНакладная.АвтомобильМасса,
	|		ТранспортнаяНакладная.МестоХраненияАвтомобиля,
	|		ВЫРАЗИТЬ(ТранспортнаяНакладная.МестоХраненияАвтомобиляЗначенияПолей КАК СТРОКА(1024)),
	...
	Пока РезультатЗапроса.Следующий() Цикл
		ИнформацияТранспортногоСредства = Новый Структура("АвтомобильГосударственныйНомер, АвтомобильМарка, АвтомобильТип, АвтомобильГрузоподъемностьВТоннах, АвтомобильВместимостьВКубическихМетрах, АвтомобильДлина, АвтомобильШирина, АвтомобильВысота, АвтомобильМасса, ЛицензионнаяКарточкаВид, ЛицензионнаяКарточкаНомер, ЛицензионнаяКарточкаРегистрационныйНомер, ЛицензионнаяКарточкаСерия, Прицеп, ГосударственныйНомерПрицепа, ВидПеревозки, МестоХраненияАвтомобиля, МестоХраненияАвтомобиляЗначенияПолей");
...
Функция УстановитьСписокВыбораМестоСоставленияДокумента(Элемент, Организация) Экспорт 
	...
	Пока РезультатЗапроса.Следующий() Цикл
		Элемент.СписокВыбора.Добавить(СокрЛП(РезультатЗапроса.МестоСоставленияДокумента));
	КонецЦикла;
...
//-- НЕ УТКА
	...
	|	ТаблицаТранспортныхНакладных.ТранспортнаяНакладная.МестоХраненияАвтомобиля КАК МестоХраненияАвтомобиля,
	...
	|	ТаблицаТранспортныхНакладных.ТранспортнаяНакладная.МестоХраненияАвтомобиля,
...
Процедура ЗаполнитьРеквизитыТранспортнойНакладной(МассивРаспоряжений, РеквизитыТранспортнойНакладной, ЗначенияЗаполнения = Неопределено, ЗаданиеНаПеревозку = Неопределено)
	...
	|	ЗаданиеНаПеревозкуМаршрут.Ссылка.АвтомобильДлина КАК АвтомобильДлина,
	|	ЗаданиеНаПеревозкуМаршрут.Ссылка.АвтомобильШирина КАК АвтомобильШирина,
	|	ЗаданиеНаПеревозкуМаршрут.Ссылка.АвтомобильВысота КАК АвтомобильВысота,
	|	ЗаданиеНаПеревозкуМаршрут.Ссылка.АвтомобильМасса КАК АвтомобильМасса,
	|	ЗаданиеНаПеревозкуМаршрут.Ссылка.МестоХраненияАвтомобиля КАК МестоХраненияАвтомобиля,
	|	ЗаданиеНаПеревозкуМаршрут.Ссылка.МестоХраненияАвтомобиляЗначенияПолей КАК МестоХраненияАвтомобиляЗначенияПолей,
	...
	|	ЗаданиеНаПеревозкуМаршрут.Ссылка.ДолжностьВодителя КАК ДолжностьВодителя,
	...
	|			ТОГДА ВЫБОР
	|					КОГДА ДокументРаспоряжениеТовары.ЗаказКлиента.СпособДоставки В (&СпособыДоставкиСНашимУчастием)
	|						ТОГДА ЕСТЬNULL(ДанныеЗаданияНаПеревозкуЗаказы.АвтомобильДлина, """")
	|					ИНАЧЕ """"
	|				КОНЕЦ
	|		ИНАЧЕ ВЫБОР
	|				КОГДА ДокументРаспоряжение.СпособДоставки В (&СпособыДоставкиСНашимУчастием)
	|					ТОГДА ЕСТЬNULL(ДанныеЗаданияНаПеревозкуНакладные.АвтомобильДлина, """")
	|				ИНАЧЕ """"
	|			КОНЕЦ
	|	КОНЕЦ КАК АвтомобильДлина, 
	|	ВЫБОР
	|		КОГДА ДокументРаспоряжение.РеализацияПоЗаказам
	|			ТОГДА ВЫБОР
	|					КОГДА ДокументРаспоряжениеТовары.ЗаказКлиента.СпособДоставки В (&СпособыДоставкиСНашимУчастием)
	|						ТОГДА ЕСТЬNULL(ДанныеЗаданияНаПеревозкуЗаказы.АвтомобильШирина, """")
	|					ИНАЧЕ """"
	|				КОНЕЦ
	|		ИНАЧЕ ВЫБОР
	|				КОГДА ДокументРаспоряжение.СпособДоставки В (&СпособыДоставкиСНашимУчастием)
	|					ТОГДА ЕСТЬNULL(ДанныеЗаданияНаПеревозкуНакладные.АвтомобильШирина, """")
	|				ИНАЧЕ """"
	|			КОНЕЦ
	|	КОНЕЦ КАК АвтомобильШирина, 
	|	ВЫБОР
	|		КОГДА ДокументРаспоряжение.РеализацияПоЗаказам
	|			ТОГДА ВЫБОР
	|					КОГДА ДокументРаспоряжениеТовары.ЗаказКлиента.СпособДоставки В (&СпособыДоставкиСНашимУчастием)
	|						ТОГДА ЕСТЬNULL(ДанныеЗаданияНаПеревозкуЗаказы.АвтомобильВысота, """")
	|					ИНАЧЕ """"
	|				КОНЕЦ
	|		ИНАЧЕ ВЫБОР
	|				КОГДА ДокументРаспоряжение.СпособДоставки В (&СпособыДоставкиСНашимУчастием)
	|					ТОГДА ЕСТЬNULL(ДанныеЗаданияНаПеревозкуНакладные.АвтомобильВысота, """")
	|				ИНАЧЕ """"
	|			КОНЕЦ
	|	КОНЕЦ КАК АвтомобильВысота, 
	|	ВЫБОР
	|		КОГДА ДокументРаспоряжение.РеализацияПоЗаказам
	|			ТОГДА ВЫБОР
	|					КОГДА ДокументРаспоряжениеТовары.ЗаказКлиента.СпособДоставки В (&СпособыДоставкиСНашимУчастием)
	|						ТОГДА ЕСТЬNULL(ДанныеЗаданияНаПеревозкуЗаказы.АвтомобильМасса, """")
	|					ИНАЧЕ """"
	|				КОНЕЦ
	|		ИНАЧЕ ВЫБОР
	|				КОГДА ДокументРаспоряжение.СпособДоставки В (&СпособыДоставкиСНашимУчастием)
	|					ТОГДА ЕСТЬNULL(ДанныеЗаданияНаПеревозкуНакладные.АвтомобильМасса, """")
	|				ИНАЧЕ """"
	|			КОНЕЦ
	|	КОНЕЦ КАК АвтомобильМасса, 
	|	ВЫБОР
	|		КОГДА ДокументРаспоряжение.РеализацияПоЗаказам
	|			ТОГДА ВЫБОР
	|					КОГДА ДокументРаспоряжениеТовары.ЗаказКлиента.СпособДоставки В (&СпособыДоставкиСНашимУчастием)
	|						ТОГДА ЕСТЬNULL(ДанныеЗаданияНаПеревозкуЗаказы.МестоХраненияАвтомобиля, """")
	|					ИНАЧЕ """"
	|				КОНЕЦ
	|		ИНАЧЕ ВЫБОР
	|				КОГДА ДокументРаспоряжение.СпособДоставки В (&СпособыДоставкиСНашимУчастием)
	|					ТОГДА ЕСТЬNULL(ДанныеЗаданияНаПеревозкуНакладные.МестоХраненияАвтомобиля, """")
	|				ИНАЧЕ """"
	|			КОНЕЦ
	|	КОНЕЦ КАК МестоХраненияАвтомобиля, 
	|	ВЫБОР
	|		КОГДА ДокументРаспоряжение.РеализацияПоЗаказам
	|			ТОГДА ВЫБОР
	|					КОГДА ДокументРаспоряжениеТовары.ЗаказКлиента.СпособДоставки В (&СпособыДоставкиСНашимУчастием)
	|						ТОГДА ЕСТЬNULL(ДанныеЗаданияНаПеревозкуЗаказы.МестоХраненияАвтомобиляЗначенияПолей, """")
	|					ИНАЧЕ """"
	|				КОНЕЦ
	|		ИНАЧЕ ВЫБОР
	|				КОГДА ДокументРаспоряжение.СпособДоставки В (&СпособыДоставкиСНашимУчастием)
	|					ТОГДА ЕСТЬNULL(ДанныеЗаданияНаПеревозкуНакладные.МестоХраненияАвтомобиляЗначенияПолей, """")
	|				ИНАЧЕ """"
	|			КОНЕЦ
	|	КОНЕЦ КАК МестоХраненияАвтомобиляЗначенияПолей, 
	|	ВЫБОР
	|		КОГДА ДокументРаспоряжение.РеализацияПоЗаказам
	|			ТОГДА ВЫБОР
	|					КОГДА ДокументРаспоряжениеТовары.ЗаказКлиента.СпособДоставки В (&СпособыДоставкиСНашимУчастием)
	...
	|			ТОГДА ВЫБОР
	|					КОГДА ДокументРаспоряжениеТовары.ЗаказКлиента.СпособДоставки В (&СпособыДоставкиСНашимУчастием)
	|						ТОГДА ЕСТЬNULL(ДанныеЗаданияНаПеревозкуЗаказы.ДолжностьВодителя, """")
	|					ИНАЧЕ """"
	|				КОНЕЦ
	|		ИНАЧЕ ВЫБОР
	|				КОГДА ДокументРаспоряжение.СпособДоставки В (&СпособыДоставкиСНашимУчастием)
	|					ТОГДА ЕСТЬNULL(ДанныеЗаданияНаПеревозкуНакладные.ДолжностьВодителя, """")
	|				ИНАЧЕ """"
	|			КОНЕЦ
	|	КОНЕЦ КАК ДолжностьВодителя,
	|	ВЫБОР
	|		КОГДА ДокументРаспоряжение.РеализацияПоЗаказам
	|			ТОГДА ВЫБОР
	|					КОГДА ДокументРаспоряжениеТовары.ЗаказКлиента.СпособДоставки В (&СпособыДоставкиСНашимУчастием)
...
Функция РеквизитыТранспортнойНакладнойДляЗаполнения()
	...
	РеквизитыТранспортнойНакладной.Вставить("АвтомобильДлина");
	РеквизитыТранспортнойНакладной.Вставить("АвтомобильШирина");
	РеквизитыТранспортнойНакладной.Вставить("АвтомобильВысота");
	РеквизитыТранспортнойНакладной.Вставить("АвтомобильМасса");
	РеквизитыТранспортнойНакладной.Вставить("МестоХраненияАвтомобиля");
	РеквизитыТранспортнойНакладной.Вставить("МестоХраненияАвтомобиляЗначенияПолей");
	...
	РеквизитыТранспортнойНакладной.Вставить("ДолжностьВодителя");  
