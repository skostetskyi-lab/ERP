...
Процедура АвтомобильГосударственныйНомерОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	ВыбранноеЗначение.Свойство("МестоХраненияАвтомобиля",					Объект.МестоХраненияАвтомобиля);
	ВыбранноеЗначение.Свойство("МестоХраненияАвтомобиляЗначенияПолей",		Объект.МестоХраненияАвтомобиляЗначенияПолей);
...
Процедура МестоХраненияАвтомобиляПриИзменении(Элемент)
	...
	ДоставкаТоваровКлиент.ПриИзмененииПредставленияАдреса(
		Элемент,
		Объект.МестоХраненияАвтомобиля,
		Объект.МестоХраненияАвтомобиляЗначенияПолей
	);
...
Процедура ПриЧтенииСозданииНаСервере()
	...
	Документы.ТранспортнаяНакладная.УстановитьСписокВыбораМестоСоставленияДокумента(Элементы.МестоСоставленияДокумента, Объект.Организация);
