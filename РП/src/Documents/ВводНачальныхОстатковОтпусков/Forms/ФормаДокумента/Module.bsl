...
Процедура СформироватьИнфоНадпись()
	...
	Если ЕстьРанееВведенныеДанные Тогда
		...
		Если Выборка.ЕстьПрава Тогда
			СборныйТекстПредупреждения = СборныйТекстПредупреждения + ?(СборныйТекстПредупреждения = "", "", НСтр("ru=' и ';uk=' та '")) + НСтр("ru='права на ежегодные отпуска';uk='права на щорічні відпустки'");
		КонецЕсли;
