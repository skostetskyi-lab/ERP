...
Процедура ЗаполнитьКлючиАналитикиУчетаПартийДокумента() Экспорт
	...
	|   ИЛИ ТаблицаТоваров.НалоговоеНазначение <> Аналитики.НалоговоеНазначение
	|   ИЛИ ТаблицаТоваров.СтавкаНДС <> Аналитики.СтавкаНДС
	|   ИЛИ &Поставщик <> Аналитики.Поставщик
	|   ИЛИ &Контрагент <> Аналитики.Контрагент
	|");
