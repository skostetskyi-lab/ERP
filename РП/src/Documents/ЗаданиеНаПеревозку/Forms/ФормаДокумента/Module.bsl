...
Процедура РеквизитыТТН(Команда)
	...
	ПараметрыТТН.Вставить("ДолжностьВодителя"); 
	...
	ПараметрыТТН.Вставить("МестоХраненияАвтомобиля");
...
Процедура ТранспортноеСредствоПриИзмененииНаСервере()
	...
	ПараметрыТТН.Вставить("АвтомобильМасса");
	ПараметрыТТН.Вставить("МестоХраненияАвтомобиля");
	ПараметрыТТН.Вставить("МестоХраненияАвтомобиляЗначенияПолей");
	ПараметрыТТН.Вставить("ЛицензионнаяКарточкаСерия");
	ПараметрыТТН.Вставить("ЛицензионнаяКарточкаНомер");
	ПараметрыТТН.Вставить("ЛицензионнаяКарточкаВид");
	ПараметрыТТН.Вставить("ЛицензионнаяКарточкаРегистрационныйНомер");
	...
	Если ЗначениеЗаполнено(Объект.ТранспортноеСредство) Тогда
		...
		|	ТранспортныеСредства.МестоХраненияАвтомобиля КАК МестоХраненияАвтомобиля, 
		|	ТранспортныеСредства.МестоХраненияАвтомобиляЗначенияПолей КАК МестоХраненияАвтомобиляЗначенияПолей, 
		...
		|	НЕОПРЕДЕЛЕНО,
		|	НЕОПРЕДЕЛЕНО,
		|	"""" КАК МестоХраненияАвтомобиля, 
		|	"""" КАК МестоХраненияАвтомобиляЗначенияПолей, 
		|	НЕОПРЕДЕЛЕНО,
		|	НЕОПРЕДЕЛЕНО,
		|	НЕОПРЕДЕЛЕНО,
		|	НЕОПРЕДЕЛЕНО,
