...
Процедура ВодительОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	ВыбранноеЗначение.Свойство("ДолжностьВодителя",		МакетДокумента.ДолжностьВодителя);
КонецПроцедуры
...
Процедура АвтомобильГосударственныйНомерОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	ВыбранноеЗначение.Свойство("АвтомобильДлина",							МакетДокумента.АвтомобильДлина);
	ВыбранноеЗначение.Свойство("АвтомобильШирина",							МакетДокумента.АвтомобильШирина);
	ВыбранноеЗначение.Свойство("АвтомобильВысота",							МакетДокумента.АвтомобильВысота);
	ВыбранноеЗначение.Свойство("АвтомобильМасса",							МакетДокумента.АвтомобильМасса);
	ВыбранноеЗначение.Свойство("МестоХраненияАвтомобиля",					МакетДокумента.МестоХраненияАвтомобиля);
	ВыбранноеЗначение.Свойство("МестоХраненияАвтомобиляЗначенияПолей",		МакетДокумента.МестоХраненияАвтомобиляЗначенияПолей);
КонецПроцедуры
...
&НаКлиенте
Процедура МестоХраненияАвтомобиляПриИзменении(Элемент)
	
	ДоставкаТоваровКлиент.ПриИзмененииПредставленияАдреса(
		Элемент,
		МакетДокумента.МестоХраненияАвтомобиля,
		МакетДокумента.МестоХраненияАвтомобиляЗначенияПолей
	);
		
КонецПроцедуры

&НаКлиенте
Процедура МестоХраненияАвтомобиляНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	
	ДоставкаТоваровКлиент.ОткрытьФормуВыбораАдресаИОбработатьРезультат(
	    Элемент,
		МакетДокумента,
		"МестоХраненияАвтомобиля",
...
&НаКлиенте
Процедура МестоХраненияАвтомобиляОчистка(Элемент, СтандартнаяОбработка)
	МестоХраненияАвтомобиляПриИзменении(Элемент);
КонецПроцедуры

&НаКлиенте
Процедура МестоХраненияАвтомобиляОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
...
Процедура ОК(Команда)
	...
	ПараметрыЗакрытия.Вставить("АвтомобильДлина");
	ПараметрыЗакрытия.Вставить("АвтомобильШирина");
	ПараметрыЗакрытия.Вставить("АвтомобильВысота");
	ПараметрыЗакрытия.Вставить("АвтомобильМасса");
	ПараметрыЗакрытия.Вставить("МестоХраненияАвтомобиля");
	ПараметрыЗакрытия.Вставить("МестоХраненияАвтомобиляЗначенияПолей");
	
	ЗаполнитьЗначенияСвойств(ПараметрыЗакрытия, МакетДокумента);
	
	ПараметрыЗакрытия.Вставить("ВодительФИО", МакетДокумента.Водитель); 
	ПараметрыЗакрытия.Вставить("ДолжностьВодителя", МакетДокумента.ДолжностьВодителя); 
