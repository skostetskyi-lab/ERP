			...
			Если ДоступенВводПредоплаты(ЭтаФорма) Тогда
				...
				Если ГрафикЗаполнен Или ГрафикСоглашенияЗаполнен Тогда
					...
					Если СуммаПредоплатыВВалютеДокумента <> СтруктураПредоплаты.СуммаПредоплаты
						...
						ТекстВопроса = НСтр("ru='Сумма предоплаты не совпадает с графиком оплаты по соглашению. Скорректировать сумму предоплаты?';uk='Сума передплати не збігається з графіком оплати за офертою. Скоригувати суму передоплати?'");
						ПоказатьВопрос(
