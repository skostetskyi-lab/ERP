...
Процедура ЗаполнитьКлючиАналитикиУчетаПартийДокумента() Экспорт
	...
	|	ТаблицаТоваров.АналитикаУчетаПартий = ЗНАЧЕНИЕ(Справочник.КлючиАналитикиУчетаПартий.ПустаяСсылка)
 	|   ИЛИ ТаблицаТоваров.ВидЗапасов.НалоговоеНазначение <> ТаблицаТоваров.АналитикаУчетаПартий.НалоговоеНазначение
	|   ИЛИ ТаблицаТоваров.СтавкаНДС <> ТаблицаТоваров.АналитикаУчетаПартий.СтавкаНДС
