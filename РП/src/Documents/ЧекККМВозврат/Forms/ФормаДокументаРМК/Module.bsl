...
Функция ИнформацияОбОплате(Форма)
	...
	КОплатеНаличными = СуммаБезСкидки - ИнформацияОбОплате.ИтогоОплачено + ИнформацияОбОплате.Наличные;
	...
	ИнформацияОбОплате.Вставить("СуммаКОплатеОкругленная", СуммаБезСкидки + СуммаОкругления);
...
Функция ИнформацияОбОплатеДляПробитияЧека(Ссылка)
	...
	|	Чек.СуммаДокумента,
	|	Чек.СуммаОкругления,
	|	Чек.ВыданоНаличными КАК ПолученоНаличными
	|ИЗ
	|	Документ.ЧекККМВозврат КАК Чек
	|ГДЕ
	|	Чек.Ссылка = &Ссылка
	|;
	|
	...
	|	И ОплатаПлатежнымиКартами.ОплатаОтменена
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
