...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИнформацияОбОплате.Свойство("КратностьОкругленияСуммыНаличныхВЧеке", КратностьОкругленияСуммыНаличныхВЧеке);
...
Процедура РассчитатьИтоги(Форма)
	...
	ПолученоНаличными = ПривестиСтрокуКЧислу(Форма.ПолученоНаличными);
	Форма.СуммаОплаты = ПолученоНаличными
	                  + Форма.ОплаченоБонуснымиБаллами
	                  + Форма.ОплаченоПлатежнымиКартами
	                  + Форма.ОплаченоСертификатами;
	
	КОплатеНаличными = Форма.КОплате - Форма.СуммаОплаты + ПолученоНаличными; 
	КОплатеНаличнымиОкругленная = ОкругленнаяСуммаНаличных(КОплатеНаличными, Форма.КратностьОкругленияСуммыНаличныхВЧеке);
	СуммаОкругления = КОплатеНаличнымиОкругленная - КОплатеНаличными;

	Переплата = Форма.СуммаОплаты - Форма.КОплате;
	ПереплатаОкругленная = Переплата - СуммаОкругления;
	
	Если ПереплатаОкругленная >= 0 Тогда
		
		Форма.СуммаСдачи   = ПереплатаОкругленная;
