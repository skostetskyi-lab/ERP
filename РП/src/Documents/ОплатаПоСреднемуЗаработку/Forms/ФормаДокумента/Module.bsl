...
Процедура ВидВремениПриИзмененииНаСервере()
	...
	ОтборПоВидуВремени = Новый Структура("ОбозначениеВТабелеУчетаРабочегоВремени,ВидДокументаНачисления,ВидВремени");
	ОтборПоВидуВремени.ОбозначениеВТабелеУчетаРабочегоВремени = Объект.ВидВремени;
	ОтборПоВидуВремени.ВидДокументаНачисления = Перечисления.ВидыДокументовНачисления.ОплатаПоСреднемуЗаработку;
	Если Объект.ВнутрисменноеОтсутствие Тогда
		ОтборПоВидуВремени.ВидВремени	 = Перечисления.ВидыРабочегоВремениСотрудников.ЧасовоеНеотработанное;
	Иначе
		ОтборПоВидуВремени.ВидВремени	 = Перечисления.ВидыРабочегоВремениСотрудников.ЦелодневноеНеотработанное;
	КонецЕсли;
