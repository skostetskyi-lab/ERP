...
Функция ОписаниеСпособовВыплатыЗарплатыПоУмолчанию()
	...
	НаименованияМежрасчетныхВыплат.Вставить(Перечисления.ВидыДокументовМежрасчетныхНачислений.БольничныйЛист,					НСтр("ru='Больничные листы';uk='Лікарняні листи'",Локализация.КодЯзыкаИнформационнойБазы()));
	НаименованияМежрасчетныхВыплат.Вставить(Перечисления.ВидыДокументовМежрасчетныхНачислений.ЕдиновременноеПособиеЗаСчетФСС,	НСтр("ru='Единовременные пособия за счет соц. страхования';uk='Одноразові допомоги за рахунок соц. страхування'",Локализация.КодЯзыкаИнформационнойБазы()));
	НаименованияМежрасчетныхВыплат.Вставить(Перечисления.ВидыДокументовМежрасчетныхНачислений.Командировка,						НСтр("ru='Командировки';uk='Відрядження'",Локализация.КодЯзыкаИнформационнойБазы()));
	НаименованияМежрасчетныхВыплат.Вставить(Перечисления.ВидыДокументовМежрасчетныхНачислений.КомпенсацияЗаЗадержкуЗарплаты,	НСтр("ru='Компенсации за задержку зарплаты';uk='Компенсації за затримку зарплати'",Локализация.КодЯзыкаИнформационнойБазы()));
	НаименованияМежрасчетныхВыплат.Вставить(Перечисления.ВидыДокументовМежрасчетныхНачислений.МатериальнаяПомощь,				НСтр("ru='Материальная помощь';uk='Матеріальна допомога'",Локализация.КодЯзыкаИнформационнойБазы()));
	НаименованияМежрасчетныхВыплат.Вставить(Перечисления.ВидыДокументовМежрасчетныхНачислений.НачислениеЗарплаты,				НСтр("ru='Доначисление';uk='Донарахування'",Локализация.КодЯзыкаИнформационнойБазы()));
	НаименованияМежрасчетныхВыплат.Вставить(Перечисления.ВидыДокументовМежрасчетныхНачислений.ОплатаПоСреднемуЗаработку,		НСтр("ru='Отсутствие с сохранением оплаты';uk='Відсутність із збереженням оплати'",Локализация.КодЯзыкаИнформационнойБазы()));
	НаименованияМежрасчетныхВыплат.Вставить(Перечисления.ВидыДокументовМежрасчетныхНачислений.Отпуск,							НСтр("ru='Отпуска';uk='Відпустки'",Локализация.КодЯзыкаИнформационнойБазы()));
	НаименованияМежрасчетныхВыплат.Вставить(Перечисления.ВидыДокументовМежрасчетныхНачислений.Премия,							НСтр("ru='Премии';uk='Премії'",Локализация.КодЯзыкаИнформационнойБазы()));
	НаименованияМежрасчетныхВыплат.Вставить(Перечисления.ВидыДокументовМежрасчетныхНачислений.ПростойСотрудников,				НСтр("ru='Простои';uk='Простої'",Локализация.КодЯзыкаИнформационнойБазы()));
	НаименованияМежрасчетныхВыплат.Вставить(Перечисления.ВидыДокументовМежрасчетныхНачислений.РазовоеНачисление,				НСтр("ru='Разовые начисления';uk='Разові нарахування'",Локализация.КодЯзыкаИнформационнойБазы()));
	НаименованияМежрасчетныхВыплат.Вставить(Перечисления.ВидыДокументовМежрасчетныхНачислений.Увольнение,						НСтр("ru='Увольнения';uk='Звільнення'",Локализация.КодЯзыкаИнформационнойБазы()));
	...
	ОписаниеЭлемента.Наименование					= НСтр("ru='Зарплата за месяц';uk='Зарплата за місяць'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	ОписаниеЭлемента = ОписаниеЭлементов.Добавить();
	ОписаниеЭлемента.Наименование					= НСтр("ru='Аванс';uk='Аванс'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	ОписаниеЭлемента = ОписаниеЭлементов.Добавить();
	ОписаниеЭлемента.Наименование					= НСтр("ru='Выплаты по договорам';uk='Виплати за договорами'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеЭлемента.ХарактерВыплаты				= Перечисления.ХарактерВыплатыЗарплаты.Зарплата;
	...
	Для Каждого ВидДокументаМежрасчетныхНачислений Из Метаданные.Перечисления.ВидыДокументовМежрасчетныхНачислений.ЗначенияПеречисления Цикл
        ...
        Если ВидДокументаМежрасчетныхНачислений.Имя = "БольничныйЛист" Тогда		
			...
			ОписаниеЭлемента = ОписаниеЭлементов.Добавить();
			ОписаниеЭлемента.Наименование					= НаименованияМежрасчетныхВыплат[ВидДокументаОснования] + НСтр("ru=' (за счет соц. страхования)';uk=' (за рахунок соц. страхування)'",Локализация.КодЯзыкаИнформационнойБазы());
			...
			ОписаниеЭлемента = ОписаниеЭлементов.Добавить();
			ОписаниеЭлемента.Наименование					= НаименованияМежрасчетныхВыплат[ВидДокументаОснования] + НСтр("ru=' (за счет предприятия)';uk=' (за рахунок підприємства)'",Локализация.КодЯзыкаИнформационнойБазы());
			ОписаниеЭлемента.ВидДокументаОснования			= ВидДокументаОснования;
        ...
        ИначеЕсли ВидДокументаМежрасчетныхНачислений.Имя = "Отпуск" Тогда		
			...
			ОписаниеЭлемента = ОписаниеЭлементов.Добавить();
			ОписаниеЭлемента.Наименование					= НаименованияМежрасчетныхВыплат[ВидДокументаОснования] + НСтр("ru=' (под расчет)';uk=' (під розрахунок)'",Локализация.КодЯзыкаИнформационнойБазы());;
			ОписаниеЭлемента.ВидДокументаОснования			= ВидДокументаОснования;
			ОписаниеЭлемента.ХарактерВыплаты				= Перечисления.ХарактерВыплатыЗарплаты.Межрасчет;
			ОписаниеЭлемента.СпособПолучения				= Перечисления.СпособыПолученияЗарплатыКВыплате.ОкончательныйРасчет;
