...
Процедура ОбновитьПоставляемыеДрайвера() Экспорт
	...
	Справочники.ДрайверыОборудования.ЗаполнитьПредопределенныйЭлемент(Перечисления.ОбработчикиДрайверовПодключаемогоОборудования.ОбработчикПРОРРОФискальныйРегистратор, "AddIn.ProRROAddIn", "ДрайверПРОРРОФискальныйРегистратор", Ложь);
	// Конец Фискальные регистраторы.
