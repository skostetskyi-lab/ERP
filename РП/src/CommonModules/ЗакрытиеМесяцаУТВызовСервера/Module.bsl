...
Процедура РассчитатьЭтап(ИмяЭтапаРасчета, Отказ = Ложь, ПараметрыРасчета)
	...
	ИначеЕсли ИмяЭтапаРасчета = "РасчетНалоговыхРазницПослеПереходаСЕН" Тогда
		РасчетНалоговыхРазницПослеПереходаСЕН(Отказ, ПараметрыРасчета)
	//-- НЕ УТ
	КонецЕсли;
КонецПроцедуры
...
Процедура РасчетНалоговыхРазницПослеПереходаСЕН(Отказ, ПараметрыРасчета)
	МассивОпераций = Новый Массив();
	МассивОпераций.Добавить(ПредопределенноеЗначение("Перечисление.ТипыРегламентныхОпераций.РасчетНалоговыхРазницПослеПереходаСЕН"));
	ПараметрыРасчета.Вставить("МассивОпераций", МассивОпераций);
	РасчетРегламентныхОпераций(Отказ, ПараметрыРасчета);
КонецПроцедуры
