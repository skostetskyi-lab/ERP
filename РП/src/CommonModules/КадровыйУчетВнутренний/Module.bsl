...
Функция СреднесписочнаяЧисленностьРаботающих(Организация, НачалоПериода, КонецПериода, ИсключатьПериодыПоПравилам1ПВ = Истина,  ИсключатьТяжелыеУсловияТруда = Ложь) Экспорт 
	...
	Возврат КадровыйУчетРасширенный.СреднесписочнаяЧисленностьРаботающих(Организация, НачалоПериода, КонецПериода, ИсключатьПериодыПоПравилам1ПВ,  ИсключатьТяжелыеУсловияТруда)	
...
Функция СреднесписочнаяЧисленностьРаботающихЭПЗ(Организация, НачалоПериода, КонецПериода, ИсключатьТяжелыеУсловияТруда = Ложь) Экспорт 
	...
	Возврат КадровыйУчетРасширенный.СреднесписочнаяЧисленностьРаботающихЭПЗ(Организация, НачалоПериода, КонецПериода, ИсключатьТяжелыеУсловияТруда)	
