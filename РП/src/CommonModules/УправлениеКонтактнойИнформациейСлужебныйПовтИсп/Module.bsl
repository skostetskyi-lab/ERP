...
Функция XSLT_ПреобразованиеXSL() Экспорт
	...
	Для Каждого ДополнительныйАдресныйЭлемент Из УправлениеКонтактнойИнформациейКлиентСервер.ТипыОбъектовАдресацииАдреса() Цикл
	...
	ИмяАдрес = "Адрес"+УправлениеКонтактнойИнформациейКлиентСервер.СуффиксНациональный();
	ИмяСубъект = "Субъект"+УправлениеКонтактнойИнформациейКлиентСервер.СуффиксНациональный();
	Преобразователь = Новый ПреобразованиеXSL;
	Преобразователь.ЗагрузитьИзСтроки("
		|<xsl:stylesheet version=""1.0"" xmlns:xsl=""http://www.w3.org/1999/XSL/Transform""
		|  xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance""
