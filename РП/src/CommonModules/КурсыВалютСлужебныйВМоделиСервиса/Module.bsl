...
Процедура РаспространитьКурсыПоОД(Знач ДатаКурсов, Знач ТаблицаКурсов, 
	...
	Для каждого ОбластьДанных Из ОбластиДляОбновления Цикл
		...
		Исключение
			...
			ЗаписьЖурналаРегистрации(НСтр("ru='Поставляемые данные.Распространение курсов валют по областям данных';uk='Дані, що постачаються. Поширення курсів валют по областях даних'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
