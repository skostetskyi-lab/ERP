...
Процедура ЗаполнитьВыплатыПоГигКонтрактам() Экспорт
	...
	ОбъектЗаполнения.Наименование = НСтр("ru='Выплаты по гиг-контрактам (663)';uk='Виплати за гіг-контрактами (663)'",Локализация.КодЯзыкаИнформационнойБазы());
