...
// Возвращает наименование региона для адреса или пустую строку, если регион не определен.
// Если переданная строка не содержит информации об адресе, то будет вызвано исключение.
//
// Параметры:
//    XMLСтрока - Строка - XML контактной информации.
...
Функция РегионАдресаКонтактнойИнформации(Знач XMLСтрока) Экспорт
	...
	Адрес = XDTOАдрес.Состав;
	Если Адрес = Неопределено Или Адрес.Тип() <> ФабрикаXDTO.Тип(ПространствоИмен, "Адрес") Тогда
		ВызватьИсключение НСтр("ru='Невозможно определить регион, ожидается адрес.';uk='Неможливо визначити регіон, очікується адреса.'");
	КонецЕсли;
	
	АдресНациональный = УправлениеКонтактнойИнформациейСлужебный.НациональныйАдрес(Адрес);
	Возврат ?(АдресНациональный = Неопределено, "", СокрЛП(АдресНациональный["Субъект"+УправлениеКонтактнойИнформациейКлиентСервер.СуффиксНациональный()]));
	
КонецФункции

// Возвращает наименование города для национального адреса или пустую строку для иностранного адреса.
// Если переданная строка не содержит информации об адресе, то будет вызвано исключение.
//
// Параметры:
//    XMLСтрока - Строка - XML контактной информации.
...
Функция ГородАдресаКонтактнойИнформации(Знач XMLСтрока) Экспорт
	...
	АдресНациональный = УправлениеКонтактнойИнформациейСлужебный.НациональныйАдрес(Адрес);
	Возврат ?(АдресНациональный = Неопределено, "", СокрЛП(АдресНациональный.Город));
