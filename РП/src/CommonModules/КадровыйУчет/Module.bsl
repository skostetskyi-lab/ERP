...
Функция СреднесписочнаяЧисленностьРаботающих(Организация, НачалоПериода, КонецПериода, ИсключатьПериодыПоПравилам1ПВ = Истина, ИсключатьТяжелыеУсловияТруда = Ложь) Экспорт 
	Возврат КадровыйУчетВнутренний.СреднесписочнаяЧисленностьРаботающих(Организация, НачалоПериода, КонецПериода, ИсключатьПериодыПоПравилам1ПВ, ИсключатьТяжелыеУсловияТруда)	
КонецФункции
...
//		КонецПериода
//
// Возвращаемое значение - Структура с полями ЧисленностьРаботниковЭПЗ
//	
Функция СреднесписочнаяЧисленностьРаботающихЭПЗ(Организация, НачалоПериода, КонецПериода, ИсключатьТяжелыеУсловияТруда = Ложь) Экспорт 
	Возврат КадровыйУчетВнутренний.СреднесписочнаяЧисленностьРаботающихЭПЗ(Организация, НачалоПериода, КонецПериода, ИсключатьТяжелыеУсловияТруда)	
КонецФункции  
...
Функция ТаблицаРабочихМестОсновныхСотрудников(ФизическиеЛицаМассив, Организация, ПериодРегистрации, Последние = Истина) Экспорт
	...
	Иначе
		...
		| МАКСИМУМ(РабочиеМестаСотрудников.РольСотрудника) КАК РольСотрудника
		|ПОМЕСТИТЬ ВТРабочиеМестаСотрудниковМаксимумРоль 
		|ИЗ
		...
		|ПОМЕСТИТЬ ВТРабочиеМестаСотрудниковРоль 
		|ИЗ
		| ВТРабочиеМестаСотрудников КАК РабочиеМестаСотрудников
		| ВНУТРЕННЕЕ СОЕДИНЕНИЕ
		| ВТРабочиеМестаСотрудниковМаксимумРоль КАК РабочиеМестаСотрудниковМаксимум
		...
		|  И РабочиеМестаСотрудников.РольСотрудника = РабочиеМестаСотрудниковМаксимум.РольСотрудника
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		...
		|ИЗ
		| ВТРабочиеМестаСотрудниковРоль КАК РабочиеМестаСотрудников
		|СГРУППИРОВАТЬ ПО
		| РабочиеМестаСотрудников.ФизическоеЛицо,
		| РабочиеМестаСотрудников.Сотрудник
		|;
