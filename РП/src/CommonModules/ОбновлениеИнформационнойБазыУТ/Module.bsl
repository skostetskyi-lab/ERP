...
#КонецОбласти // ЗаполнитьДвиженияДеньгиВПути
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Перезаполняет движения по регистру ""Расчеты с поставщиками"" для документов ""Списание безналичных денежных средств"".';uk='Перезаповнює рухи по регістру ""Розрахунки з постачальниками"" для документів ""Списання безготівкових коштів"".'");
    Обработчик.НеЗаполнятьДанныеВОбработчикеПодредакции = Истина;
...
#Область Версия_3_2_2
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Заполняет движения по регистру ""Переданная возвратная тара"" для документов ""Реализация товаров и услуг"" в статусе ""К отгрузке""';uk='Заповнює рухи по регістру ""Передана зворотна тара"" для документів ""Реалізація товарів і послуг"" в статус ""До відвантаження""'");
...
#Область Версия_3_2_3
    ...
    |- для документів ""Переміщення товарів"" і ""Збірка (розбирання) товарів"" на замовлення видаляє рухи і додає такі ж рухи в документи ""Замовлення на переміщення"" і ""Замовлення на збірку"".'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Перезаполняет в регистре статьи при начислении и оплате имущественных налогов, НДФЛ и страховых взносов на предопределенную статью ""Налоги"". Перезаполняет в регистре статьи, когда в документе статья указана, а в движениях - нет.';uk='Перезаповнює в регістрі статті при нарахуванні та оплаті майнових податків, ПДФО і страхових внесків на напередвизначену статтю ""Податки"". Перезаповнює в регістрі статті, коли в документі зазначена стаття, а в рухах - ні.'");
    ...
    |;uk='Коригує рухи по регістру ""Рухи грошових коштів"".
    ...
    |Пока обработчик не завершен, данные в регистре некорректны.'
    |;uk='Коригує рухи по регістру ""Рухи кошти доходи витрати"".
    |Поки обробник не завершений, дані в регістрі некоректні.'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Очищает движения по РН ""Заявки на возврат товаров от клиента"" для отмененных строк по ресурсу КОформлению';uk='Очищає рухи по РН  ""Заявки на повернення товарів від клієнта"" для скасованих рядків по ресурсу КОформлению'");
...
#Область Версия_3_2_33  

#Область СтатьиНалоговыхДеклараций

	Обработчик = Обработчики.Добавить();
  	Обработчик.Версия = "3.2.33.1";
	Обработчик.РежимВыполнения = "Монопольно";
	Обработчик.Процедура = "Справочники.СтатьиНалоговыхДеклараций.ОбновитьПредопределенныеСтатьи";
	Обработчик.Комментарий = НСтр("ru='Обновляет предопределенные элементы справочника ""Статьи налоговых деклараций"".';uk='Оновлює напередвизначені елементи довідника ""Статті податкових декларацій"".'");
...
#КонецОбласти // Версия_3_2_33 

#Область Версия_3_2_34  

	Обработчик = Обработчики.Добавить();
    Обработчик.Версия = "3.2.34.3";
    Обработчик.РежимВыполнения = "Монопольно";
...
#КонецОбласти // Версия_3_2_34    

#Область Версия_3_2_35

#Область Справочники_НастройкиХозяйственныхОпераций_ЗаполнитьПредопределенныеНастройкиХозяйственныхОпераций

	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "3.2.35.2";
	Обработчик.РежимВыполнения = "Монопольно";
	Обработчик.Процедура = "Справочники.НастройкиХозяйственныхОпераций.ЗаполнитьПредопределенныеНастройкиХозяйственныхОпераций";
	Обработчик.Комментарий = НСтр("ru='Обновляет реквизиты предопределенных элементов справочника ""Хозяйственные операции"" согласно заданным настройкам в текстовых макетах.';uk='Оновлює реквізити напередвизначених елементів довідника ""Господарські операції"" згідно заданим настройкам в текстових макетах.'");
...
#Область Версия_3_2_36

#Область СтатьиНалоговыхДеклараций

	Обработчик = Обработчики.Добавить();
  	Обработчик.Версия = "3.2.36.1";
	Обработчик.РежимВыполнения = "Монопольно";
	Обработчик.Процедура = "Справочники.СтатьиНалоговыхДеклараций.ОбновитьПредопределенныеСтатьи";
	Обработчик.Комментарий = НСтр("ru='Обновляет предопределенные элементы справочника ""Статьи налоговых деклараций"".';uk='Оновлює напередвизначені елементи довідника ""Статті податкових декларацій"".'");
...
#Область Версия_3_2_37

#Область СтатьиНалоговыхДеклараций

	Обработчик = Обработчики.Добавить();
  	Обработчик.Версия = "3.2.37.1";
	Обработчик.РежимВыполнения = "Монопольно";
	Обработчик.Процедура = "Справочники.СтатьиНалоговыхДеклараций.ОбновитьПредопределенныеСтатьи";
	Обработчик.Комментарий = НСтр("ru='Обновляет предопределенные элементы справочника ""Статьи налоговых деклараций"".';uk='Оновлює напередвизначені елементи довідника ""Статті податкових декларацій"".'");
...
#Область Версия_3_2_40

#Область СтатьиНалоговыхДеклараций

	Обработчик = Обработчики.Добавить();
  	Обработчик.Версия = "3.2.40.1";
	Обработчик.РежимВыполнения = "Монопольно";
	Обработчик.Процедура = "Справочники.СтатьиНалоговыхДеклараций.ОбновитьПредопределенныеСтатьи";
	Обработчик.Комментарий = НСтр("ru='Обновляет предопределенные элементы справочника ""Статьи налоговых деклараций"".';uk='Оновлює напередвизначені елементи довідника ""Статті податкових декларацій"".'");
...
#Область Версия_3_2_41 

	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "3.2.41.5";
	Обработчик.РежимВыполнения = "Монопольно";
	Обработчик.Процедура = "ПланыВидовХарактеристик.СтатьиРасходов.ЗаполнитьСтатьяРасходовОкруглениеНаличныхПриРозничныхПродажах";
	Обработчик.Комментарий = НСтр("ru='Обновляет реквизиты предопределенных элементов плана видов характеристик ""Статьи расходов"".';uk='Оновлює реквізити напередвизначених елементів плану видів характеристик ""Статті витрат"".'");

	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "3.2.41.5";
	Обработчик.РежимВыполнения = "Монопольно";
	Обработчик.Процедура = "ПланыВидовХарактеристик.СтатьиДоходов.ЗаполнитьСтатьяДоходовОкруглениеНаличныхПриРозничныхПродажах";
	Обработчик.Комментарий = НСтр("ru='Обновляет реквизиты предопределенных элементов плана видов характеристик ""Статьи доходов"".';uk='Оновлює реквізити напередвизначених елементів плану видів характеристик ""Статті доходів"".'");

	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "3.2.41.6";
	Обработчик.РежимВыполнения = "Монопольно";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыУТ.ЗаполнитьКонстантуКратностьОкругленияСуммыНаличныхВЧеке";
	Обработчик.Комментарий = НСтр("ru='Устанавливает значение константы ""Кратность округления суммы наличных в чеке""';uk='Встановлює значення константи ""Кратність зоокруглення суми готівки в чеку""'");
...
#Область РегистрыНакопления_ДенежныеСредстваВПути_ОбработатьДанныеДляПереходаНаНовуюВерсию
    ...
    |До завершення обробки дані по еквайрингу та коштам в дорозі можуть бути некоректними.'");
...
#Область РегистрыНакопления_ДенежныеСредстваВПути_ОбработатьДанныеДляПереходаНаНовуюВерсию
    ...
    |;uk='Виправляє рухи регістра ""Грошові кошти в дорозі"" документів ""Надходження безготівкових ГК"" з госп. операцією ""Конвертація валюти"".
...
#Область Версия_3_2_25
	...
	Обработчик.Комментарий = НСтр("ru='Заполняет реквизит ""Номер платежного документа"" в регистре накопления ""Книга доходов расходов по единому налогу""';uk='Заповнює реквізит ""Номер платіжного документа"" у регістрі накопичення ""Книга доходів витрат з єдиного податку""'");
...
#Область Версия_3_2_33
    ...
    Обработчик.Версия = "3.2.33.7";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Процедура = "РегистрыНакопления.ПрочиеАктивыПассивы.СформироватьДвиженияПоАкцизу";
	Обработчик.ПроцедураЗаполненияДанныхОбновления = "РегистрыНакопления.ПрочиеАктивыПассивы.СформироватьДвиженияПоАкцизу_ДанныеДляОбновления";
    Обработчик.ОчередьОтложеннойОбработки = 406;
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "РегистрНакопления.ПрочиеАктивыПассивы";
    ...
    Обработчик.Версия = "3.2.33.7";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Процедура = "РегистрыНакопления.ДвиженияКонтрагентДоходыРасходы.СформироватьДвиженияПоАкцизу";
	Обработчик.ПроцедураЗаполненияДанныхОбновления = "РегистрыНакопления.ДвиженияКонтрагентДоходыРасходы.СформироватьДвиженияПоАкцизу_ДанныеДляОбновления";
    Обработчик.ОчередьОтложеннойОбработки = 406;
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "РегистрНакопления.ДвиженияКонтрагентДоходыРасходы";
    ...
    Обработчик.Версия = "3.2.33.7";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Процедура = "РегистрыНакопления.ДвиженияДоходыРасходыПрочиеАктивыПассивы.СформироватьДвиженияПоАкцизу";
	Обработчик.ПроцедураЗаполненияДанныхОбновления = "РегистрыНакопления.ДвиженияДоходыРасходыПрочиеАктивыПассивы.СформироватьДвиженияПоАкцизу_ДанныеДляОбновления";
    Обработчик.ОчередьОтложеннойОбработки = 406;
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "РегистрНакопления.ДвиженияДоходыРасходыПрочиеАктивыПассивы";
...
Процедура ЗаполнитьКонстантуКратностьОкругленияСуммыНаличныхВЧеке() Экспорт
	
	Константы.КратностьОкругленияСуммыНаличныхВЧеке.Установить(0.5);
