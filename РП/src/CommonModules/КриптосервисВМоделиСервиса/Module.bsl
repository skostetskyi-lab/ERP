...
Функция ПолучитьПроверочныйКод(Знач ПредметПроверки, ПовторнаяОтправка = Ложь, Тип = "phone") Экспорт
	...
	Исключение
		Если Тип = "phone" Тогда
			Событие = НСтр("ru='Электронная подпись в модели сервиса.Криптосервис.Проверка мобильного телефона';uk='Електронний підпис моделі сервісу.Криптосервіс.Перевірка мобільного телефону'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
		Иначе
			Событие = НСтр("ru='Электронная подпись в модели сервиса.Криптосервис.Проверка электронной почты';uk='Електронний підпис моделі сервісу.Криптосервіс.Перевірка електронної пошти'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
		КонецЕсли;
...
Функция ПроверитьНомерТелефона(НомерТелефона, ПроверочныйКод) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Электронная подпись в модели сервиса.Криптосервис.Проверка мобильного телефона';uk='Електронний підпис моделі сервісу.Криптосервіс.Перевірка мобільного телефону'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			КомментарийПоИсключению(
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
...
Функция ПроверитьАдресЭлектроннойПочты(АдресЭлектроннойПочты, ПроверочныйКод) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Электронная подпись в модели сервиса.Криптосервис.Проверка электронной почты';uk='Електронний підпис моделі сервісу.Криптосервіс.Перевірка електронної пошти'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			КомментарийПоИсключению(
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
...
Функция ПолучитьВременныйПароль(Идентификатор, ПовторнаяОтправка = Ложь, Тип = "phone") Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Электронная подпись в модели сервиса.Криптосервис.Получение временного пароля';uk='Електронний підпис моделі сервісу.Криптосервіс.Отримання тимчасового пароля'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			КомментарийПоИсключению(
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
...
Функция ПолучитьСеансовыйКлюч(Идентификатор, ВременныйПароль) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Электронная подпись в модели сервиса.Криптосервис.Получение сеансового ключа';uk='Електронний підпис моделі сервісу.Криптосервіс.Отримання сеансового ключа'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			КомментарийПоИсключению(
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
...
Функция Авторизован(Идентификатор) Экспорт
	...
	Если ЗначениеЗаполнено(СеансовыйКлюч) Тогда
		...
		Исключение
			ЗаписьЖурналаРегистрации(
				НСтр("ru='Электронная подпись в модели сервиса.Криптосервис.Авторизация';uk='Електронний підпис моделі сервісу.Криптосервіс.Авторизація'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
				УровеньЖурналаРегистрации.Ошибка,,,
				КомментарийПоИсключению(
					ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
...
Функция ПолучитьСвойстваСертификата(Сертификат) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Электронная подпись в модели сервиса.Криптосервис.Получение свойств сертификата';uk='Електронний підпис моделі сервісу.Криптосервіс.Отримання властивостей сертифіката'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			КомментарийПоИсключению(
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
...
Функция Подписать(Идентификатор, ИсходныеДанные, ВключатьИсходныеДанные) Экспорт
    ...
    Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Электронная подпись в модели сервиса.Криптосервис.Подписание';uk='Електронний підпис моделі сервісу.Криптосервіс.Підписання'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			КомментарийПоИсключению(
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
...
Функция ПодписатьДанные(Идентификатор, ИсходныеДанные) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Электронная подпись в модели сервиса.Криптосервис.Подписание данных';uk='Електронний підпис моделі сервісу.Криптосервіс.Підписання даних'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			КомментарийПоИсключению(
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
...
Функция ПроверитьПодпись(Сертификат, Подпись, ИсходныеДанные) Экспорт
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Электронная подпись в модели сервиса.Криптосервис.Проверка подписи';uk='Електронний підпис моделі сервісу.Криптосервіс.Перевірка підпису'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			КомментарийПоИсключению(
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
...
Функция Зашифровать(Идентификатор, СертификатыПолучателей, ИсходныеДанные) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Электронная подпись в модели сервиса.Криптосервис.Шифрование';uk='Електронний підпис моделі сервісу.Криптосервіс.Шифрування'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			КомментарийПоИсключению(
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
...
Функция Расшифровать(Идентификатор, ЗашифрованныеДанные, Идентификаторы = Неопределено) Экспорт
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Электронная подпись в модели сервиса.Криптосервис.Дешифрование';uk='Електронний підпис моделі сервісу.Криптосервіс.Дешифрування'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			КомментарийПоИсключению(
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
...
Функция ПодписатьИЗашифровать(Идентификатор, СертификатыПолучателей, ИсходныеДанные) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Электронная подпись в модели сервиса.Криптосервис.Подписание и шифрование';uk='Електронний підпис моделі сервісу.Криптосервіс.Підписання та шифрування'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			КомментарийПоИсключению(
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
				Новый Структура("Идентификатор,СертификатыПолучателей,ИсходныеДанные", Идентификатор, СертификатыПолучателей, ИсходныеДанные)));
...
Функция ХешироватьДанные(ИсходныеДанные) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Электронная подпись в модели сервиса.Криптосервис.Хеширование данных';uk='Електронний підпис моделі сервісу.Криптосервіс.Хешування даних'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
			УровеньЖурналаРегистрации.Ошибка,,,
			КомментарийПоИсключению(
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
...
Функция ПолучитьСпособыДоставкиПаролей(Идентификатор) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Электронная подпись в модели сервиса.Криптосервис.Получение способов доставки паролей';uk='Електронний підпис моделі сервісу.Криптосервіс.Отримання способів доставки паролів'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			КомментарийПоИсключению(
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
				Новый Структура("Идентификатор", Идентификатор)));
...
Функция СообщениеСПаролемДоставлено(Идентификатор) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Электронная подпись в модели сервиса.Криптосервис.Получение статуса SMS';uk='Електронний підпис моделі сервісу.Криптосервіс.Отримання статусу SMS'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			КомментарийПоИсключению(
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
				Новый Структура("Идентификатор", Идентификатор)));
...
Функция ПолучитьСвойстваКриптосообщения(Криптосообщение, ТолькоКлючевыеСвойства = Ложь) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Электронная подпись в модели сервиса.Криптосервис.Получение свойств криптосообщения';uk='Електронний підпис моделі сервісу.Криптосервіс.Отримання властивостей криптосообщения'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
