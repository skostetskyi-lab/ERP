...
Процедура СоздатьПоказателиПоНастройкам(НастройкиРасчетаЗарплаты = Неопределено, ПараметрыПланаВидовРасчета = Неопределено) Экспорт
	...
	ОписаниеПоказателя.Наименование = НСтр("ru='Время в днях';uk='Час в днях'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	ОписаниеПоказателя.Наименование = НСтр("ru='Время в днях (или часах)';uk='Час в днях (або годинах)'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Время в днях (часах)';uk='Час в днях (годинах)'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.ОтображатьВДокументахНачисления = Ложь;
	...
	ОписаниеПоказателя.Наименование = НСтр("ru='Норма дней по графику полного рабочего времени';uk='Норма днів за графіком повного робочого часу'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Норма дн. полн.граф.';uk='Норма дн. повн.граф.'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.ОтображатьВДокументахНачисления = Ложь;
	ЗаписатьПоказатель(ОписаниеПоказателя);
	...
	ОписаниеПоказателя.Наименование = НСтр("ru='Календарные дни';uk='Календарні дні'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Календ. дн.';uk='Календ. дн.'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.ОтображатьВДокументахНачисления = Ложь;
	ЗаписатьПоказатель(ОписаниеПоказателя);
	
	ОписаниеПоказателя = ОписаниеПоказателя();
	ОписаниеПоказателя.Идентификатор = "КалендарныеДниМесяца";
	ОписаниеПоказателя.Наименование = НСтр("ru='Календарные дни месяца';uk='Календарні дні місяця'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Календ. дн. (мес)';uk='Календ. дн. (міс)'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.ОтображатьВДокументахНачисления = Ложь;
	ЗаписатьПоказатель(ОписаниеПоказателя);
	
	ОписаниеПоказателя = ОписаниеПоказателя();
	ОписаниеПоказателя.Идентификатор = "КалендарныеДниБезПраздников";
	ОписаниеПоказателя.Наименование = НСтр("ru='Календарные дни без праздников';uk='Календарні дні без свят'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Кал. дн. без праздн.';uk='Кал. дн. без святк.'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.ОтображатьВДокументахНачисления = Ложь;
	ЗаписатьПоказатель(ОписаниеПоказателя);
	
	ОписаниеПоказателя = ОписаниеПоказателя();
	ОписаниеПоказателя.Идентификатор = "МРОТ";
	ОписаниеПоказателя.Наименование = НСтр("ru='МРОТ';uk='МРОП'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	ОписаниеПоказателя.Наименование = НСтр("ru='МЧТС';uk='МГТС'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
	ОписаниеПоказателя.НазначениеПоказателя = Перечисления.НазначенияПоказателейРасчетаЗарплаты.ДляОрганизации;
	ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
	ЗаписатьПоказатель(ОписаниеПоказателя);
	...
	ОписаниеПоказателя.Наименование = НСтр("ru='Прожиточный минимум';uk='Прожитковий мінімум'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
	ОписаниеПоказателя.НазначениеПоказателя = Перечисления.НазначенияПоказателейРасчетаЗарплаты.ДляОрганизации;
	ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
	ЗаписатьПоказатель(ОписаниеПоказателя);	
	...
	ОписаниеПоказателя.Наименование = НСтр("ru='Коэффициент индексации';uk='Коефіцієнт індексації'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Коэф. индексации';uk='Коеф. індексації'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.Точность = 3;
	ЗаписатьПоказатель(ОписаниеПоказателя);
	...
	ОписаниеПоказателя.Наименование = НСтр("ru='Расчетная база';uk='Розрахункова база'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Расч. база';uk='Розрах. база'",Локализация.КодЯзыкаИнформационнойБазы());
	ЗаписатьПоказатель(ОписаниеПоказателя);
	
	ОписаниеПоказателя = ОписаниеПоказателя();
	ОписаниеПоказателя.Идентификатор = "СреднийЗаработокОбщий";
	ОписаниеПоказателя.Наименование = НСтр("ru='Средний заработок (общий)';uk='Середній заробіток (загальний)'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Ср. заработок (общ.)';uk='Сер. заробіток (заг.)'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.Точность = 2;
	ЗаписатьПоказатель(ОписаниеПоказателя);
	
	ОписаниеПоказателя = ОписаниеПоказателя();
	ОписаниеПоказателя.Идентификатор = "СреднийЗаработокОтпуск";
	ОписаниеПоказателя.Наименование = НСтр("ru='Средний заработок (отпуск)';uk='Середній заробіток (відпуска)'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Ср. заработок (отп.)';uk='Сер. заробіток (відп.)'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.Точность = 2;
	ЗаписатьПоказатель(ОписаниеПоказателя);
	...
	ОписаниеПоказателя.Наименование = НСтр("ru='Средний заработок соц. страхование';uk='Середній заробіток соц. страхування'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Ср. заработок (соц.)';uk='Сер. заробіток (соц.)'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.Точность = 2;
	ЗаписатьПоказатель(ОписаниеПоказателя);
	...
	ОписаниеПоказателя.Наименование = НСтр("ru='Тарифная ставка (дневная)';uk='Тарифна ставка (денна)'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Дневн. тариф';uk='Ден. тариф'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
	ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;
	ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
	ОписаниеПоказателя.Точность = ПараметрыПоказателей.ОкладТарифТочность;
	...
	ОписаниеПоказателя.Наименование = НСтр("ru='Стоимость дня';uk='Вартість дня'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Дневн. стоим.';uk='Ден. варт.'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.Точность = 3;
	ЗаписатьПоказатель(ОписаниеПоказателя);

	ОписаниеПоказателя = ОписаниеПоказателя();
	ОписаниеПоказателя.Идентификатор = "СтоимостьЧаса";
	ОписаниеПоказателя.Наименование = НСтр("ru='Стоимость часа';uk='Вартість години'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Час. стоим.';uk='Год. варт.'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.Точность = 3;
	ЗаписатьПоказатель(ОписаниеПоказателя);
	...
	ОписаниеПоказателя.Наименование = НСтр("ru='Отработано дней, в т.ч. сверхурочно';uk='Відпрацьовано днів, в т. ч. понаднормово'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Отраб. (дни)';uk='Відпрац. (дні)'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.ОтображатьВДокументахНачисления = Ложь;
	ЗаписатьПоказатель(ОписаниеПоказателя);
	...
	Если ПараметрыПланаВидовРасчета.НатуральныеДоходы.ОплатаТрудаВНатуральнойФорме Тогда
		...
		ОписаниеПоказателя.Наименование = НСтр("ru='Натуральная оплата';uk='Натуральна оплата'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Натур. оплата';uk='Натур. оплата'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
		ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;
		ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
	...
	Если НастройкиРасчетаЗарплаты.ИспользоватьСовмещениеПрофессийДолжностей Тогда
		...
		ОписаниеПоказателя.Наименование = НСтр("ru='Размер доплаты за совмещение';uk='Розмір доплати за сумісництво'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='За совмещ.';uk='За сумісн.'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
		ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;
		ОписаниеПоказателя.Точность = 2;
		ЗаписатьПоказатель(ОписаниеПоказателя);
	...
	Если НастройкиРасчетаЗарплаты.ИспользоватьОплатуСверхурочных Тогда
		...
		ОписаниеПоказателя.Наименование = НСтр("ru='Отработано сверхурочно';uk='Відпрацьовано понаднормово'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Сверхурочно (всего)';uk='Понаднормово (всього)'",Локализация.КодЯзыкаИнформационнойБазы());
		ЗаписатьПоказатель(ОписаниеПоказателя);
		// Сверхурочно в пределах 2 часов.
		ОписаниеПоказателя = ОписаниеПоказателя();
		ОписаниеПоказателя.Идентификатор = "ОтработаноСверхурочноВПределах2Часов";
		ОписаниеПоказателя.Наименование = НСтр("ru='Отработано сверхурочно в пределах 2 часов';uk='Відпрацьовано понаднормово в межах 2 годин'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Сверхурочно (до 2 ч)';uk='Понаднормово (до 2 год)'",Локализация.КодЯзыкаИнформационнойБазы());
		ЗаписатьПоказатель(ОписаниеПоказателя);
	Иначе
	...
	Если НастройкиРасчетаЗарплаты.ИспользоватьСдельныйЗаработок Тогда
		...
		ОписаниеПоказателя.Наименование = НСтр("ru='Сдельный заработок';uk='Відрядний заробіток'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Сдельно';uk='Відрядно'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.Точность = 2;
		ОписаниеПоказателя.СпособВводаЗначений = Перечисления.СпособыВводаЗначенийПоказателейРасчетаЗарплаты.НакапливаетсяПоОтдельнымЗначениям;
		ЗаписатьПоказатель(ОписаниеПоказателя);
	Иначе
	...
	Если ПараметрыПремия.ИспользоватьПремиюПроцентом Тогда
		...
		ОписаниеПоказателя.Наименование = НСтр("ru='Процент ежемесячной премии';uk='Відсоток щомісячної премії'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Если ПараметрыПремия.ИспользоватьПремиюСуммой Тогда
		...
		ОписаниеПоказателя.Наименование = НСтр("ru='Сумма ежемесячной премии';uk='Сума щомісячної премії'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Сумма прем.';uk='Сума прем.'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;
		ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
		ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
		ОписаниеПоказателя.Точность = 2;
	...
	Если ПараметрыПремия.ИспользоватьПремиюСуммой И ПараметрыПремия.НачисляетсяПоЗначениюПоказателей Тогда
		...
		ОписаниеПоказателя.Наименование = НСтр("ru='Сумма годовой премии';uk='Сума річної премії'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Сумма прем.';uk='Сума прем.'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;
		ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
		ОписаниеПоказателя.Точность = 2;
	...
	Если ПараметрыПремия.ИспользоватьПремиюПроцентом Тогда
		...
		ОписаниеПоказателя.Наименование = НСтр("ru='Процент годовой премии';uk='Відсоток річної премії'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='% прем.';uk='% прем.'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;
		ОписаниеПоказателя.Точность = 2;
		ОписаниеПоказателя.Предопределенный = Ложь;
	...
	Если ПараметрыПремия.ИспользоватьПремиюСуммой И ПараметрыПремия.НачисляетсяПоЗначениюПоказателей Тогда
		...
		ОписаниеПоказателя.Наименование = НСтр("ru='Сумма квартальной премии';uk='Сума квартальної премії'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Сумма прем.';uk='Сума прем.'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;
		ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
		ОписаниеПоказателя.Точность = 2;
	...
	Если ПараметрыПремия.ИспользоватьПремиюПроцентом Тогда
		...
		ОписаниеПоказателя.Наименование = НСтр("ru='Процент квартальной премии';uk='Відсоток квартальної премії'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='% прем.';uk='% прем.'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;
		ОписаниеПоказателя.Точность = 2;
		ОписаниеПоказателя.Предопределенный = Ложь;
	...
	Если ПараметрыПремия.ИспользоватьПремиюСуммой И ПараметрыПремия.НачисляетсяПоЗначениюПоказателей Тогда 
		...
		ОписаниеПоказателя.Наименование = НСтр("ru='Размер разовой премии';uk='Розмір разової премії'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Сумма прем.';uk='Сума прем.'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;
		ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
		ОписаниеПоказателя.Предопределенный = Ложь;
	...
	Если ПараметрыПремия.ИспользоватьПремиюПроцентом Тогда 
		...
		ОписаниеПоказателя.Наименование = НСтр("ru='Процент разовой премии';uk='Відсоток разової премії'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='% прем.';uk='% прем.'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;
		ОписаниеПоказателя.Предопределенный = Ложь;
		ОписаниеПоказателя.Точность = 2;
	...
	Если ПараметрыПланаВидовРасчета.ИспользоватьДоплатуЗаВыручкуОтРеализации Тогда
		...
		ОписаниеПоказателя.Наименование = НСтр("ru='Выручка';uk='Виторг'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Выручка';uk='Виторг'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;
		ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
		ОписаниеПоказателя.Предопределенный = Ложь;
		ОписаниеПоказателя.Точность = 2;
		...
		ОписаниеПоказателя.Наименование = НСтр("ru='Процент доплаты за выручку';uk='Відсоток доплати за виторг'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='% за выручку';uk='% за виторг'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;
		ОписаниеПоказателя.НазначениеПоказателя = Перечисления.НазначенияПоказателейРасчетаЗарплаты.ДляОрганизации;
	...
	Если ПараметрыПланаВидовРасчета.ИспользоватьДоплатуЗаВыполнениеПлана Тогда
		...
		ОписаниеПоказателя.Наименование = НСтр("ru='Выполнение плана';uk='Виконання плану'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Вып. плана';uk='Вик. плану'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;
		ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Числовой;
		ОписаниеПоказателя.Точность = 2;
		ОписаниеПоказателя.Предопределенный = Ложь;
		...
		ОписаниеПоказателя.НачальнаяНастройка = ПараметрыПланаВидовРасчета.НачальнаяНастройкаПрограммы;
		ОписаниеПоказателя.Наименование = НСтр("ru='План';uk='План'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='План';uk='План'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;
	...
	ОписаниеПоказателя.Наименование = НСтр("ru='Количество дней отпуска';uk='Кількість днів відпустки'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Дней отпуска';uk='Днів відпустки'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Истина;
	ЗаписатьПоказатель(ОписаниеПоказателя);
	
	ОписаниеПоказателя = ОписаниеПоказателя();
	ОписаниеПоказателя.Идентификатор = "КоличествоДнейКомпенсации";
	ОписаниеПоказателя.Наименование = НСтр("ru='Количество дней компенсации отпуска';uk='Кількість днів компенсації відпустки'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Дней компенсац.';uk='Днів компенсац.'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Истина;
	ЗаписатьПоказатель(ОписаниеПоказателя);
	
	ОписаниеПоказателя = ОписаниеПоказателя();
	ОписаниеПоказателя.Идентификатор = "ДнейЧасовВыходногоПособия";
	ОписаниеПоказателя.Наименование = НСтр("ru='Количество оплачиваемых дней (часов) выходного пособия';uk='Кількість оплачуваних днів (годин) вихідної допомоги'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Дней(часов) вых. пособия.';uk='Днів(годин) вих. допомоги.'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Истина;
	ЗаписатьПоказатель(ОписаниеПоказателя);
	
	ОписаниеПоказателя = ОписаниеПоказателя();
	ОписаниеПоказателя.Идентификатор = "РазмерПособияПоУходуЗаРебенкомДоТрехЛет";
	ОписаниеПоказателя.Наименование = НСтр("ru='Размер пособия по уходу за ребенком до трех лет';uk='Розмір допомоги по догляду за дитиною до трьох років'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Пособие до трех лет';uk='Допомога до трьох років'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
	ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
	ЗаписатьПоказатель(ОписаниеПоказателя);
	...
	ОписаниеПоказателя.Наименование = НСтр("ru='Процент оплаты по среднему заработку';uk='Відсоток оплати по середньому заробітку'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='% оплаты по сред.';uk='% оплати за серед.'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Истина;
	ЗаписатьПоказатель(ОписаниеПоказателя);
	
	ОписаниеПоказателя = ОписаниеПоказателя();
	ОписаниеПоказателя.Идентификатор = "ПроцентДоплатыЗаДниНетрудоспособности";
	ОписаниеПоказателя.Наименование = НСтр("ru='Процент доплаты за дни нетрудоспособности';uk='Відсоток доплати за дні непрацездатності'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='% доплаты до сред.';uk='% доплати до серед.'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Истина;
	ЗаписатьПоказатель(ОписаниеПоказателя);
	...
	Если НастройкиРасчетаЗарплаты.ИспользоватьПрофсоюзныеВзносы Тогда
		...
		ОписаниеПоказателя.Наименование = НСтр("ru='Процент профсоюзных взносов';uk='Відсоток профспілкових внесків'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='% профвзносов';uk='% профвнесків'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;
		ОписаниеПоказателя.Точность = 2;
		ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
		ЗаписатьПоказатель(ОписаниеПоказателя);
	...
	Если НастройкиРасчетаЗарплаты.ИспользоватьТарифныеСеткиПриРасчетеЗарплаты Тогда
		...
		ОписаниеПоказателя.Наименование = НСтр("ru='Размер доплаты за квалификацию';uk='Розмір доплати за кваліфікацію'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Доплата за квалиф.';uk='Доплата за кваліф.'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
		ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;
		ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
		ОписаниеПоказателя.Точность = ПараметрыПоказателей.ОкладТарифТочность;
	...
	Если НастройкиРасчетаЗарплаты.ИспользоватьТарифныеСеткиПриРасчетеЗарплаты Тогда
		...
		ОписаниеПоказателя.Наименование = НСтр("ru='Размер дневной доплаты за квалификацию';uk='Розмір денної доплати за кваліфікацію'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Дн. допл. за квалиф.';uk='Дн. допл. за кваліф.'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
		ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;
		ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
		ОписаниеПоказателя.Точность = ПараметрыПоказателей.ОкладТарифТочность;
...
Процедура СоздатьПоказательДолжностнаяНадбавка(НастройкиРасчетаЗарплаты = Неопределено) Экспорт	
	...
	Если ИспользоватьКвалификационнуюНадбавку Тогда
		...
		ОписаниеПоказателя.Наименование = НСтр("ru='Должностная надбавка';uk='Посадова надбавка'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Должн. надбавка';uk='Посад. надбавка'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
		ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
		ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;
		ЗаписатьПоказатель(ОписаниеПоказателя);
...
Процедура СоздатьПоказательКвалификационнаяНадбавка(НастройкиРасчетаЗарплаты = Неопределено) Экспорт	
	...
	Если ИспользоватьКвалификационнуюНадбавку Тогда
		...
		ОписаниеПоказателя.Наименование = НСтр("ru='Квалификационная надбавка';uk='Кваліфікаційна надбавка'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Квалиф. надбавка';uk='Кваліф. надбавка'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
		ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
		ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;
		ЗаписатьПоказатель(ОписаниеПоказателя);
...
Процедура СоздатьПоказательНадбавкаЗаВредность(НастройкиРасчетаЗарплаты = Неопределено) Экспорт
	...
	Если ИспользоватьНадбавкуЗаВредность Тогда
		...
		ОписаниеПоказателя.Наименование = НСтр("ru='Процент надбавки за вредность';uk='Відсоток надбавки за шкідливість'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='% надб.';uk='% надб.'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;
		ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
		ОписаниеПоказателя.Точность = 2;
		ЗаписатьПоказатель(ОписаниеПоказателя);
...
Процедура СоздатьПоказательОкладПоДолжности(ПараметрыПланаВидовРасчета = Неопределено) Экспорт
	...
	ОписаниеПоказателя.Наименование = НСтр("ru='Оклад по должности';uk='Оклад за посадою'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Оклад по должн.';uk='Оклад за посад.'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
	ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;
	ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
	ОписаниеПоказателя.ВидТарифнойСтавки = Перечисления.ВидыТарифныхСтавок.МесячнаяТарифнаяСтавка;
...
Процедура СоздатьПоказательЧасовойТарифПоДолжности(ПараметрыПланаВидовРасчета = Неопределено, НастройкиРасчетаЗарплаты = Неопределено) Экспорт
	...
	Если НастройкиРасчетаЗарплаты.ИспользоватьУчетВремениСотрудниковВЧасах 
		...
		ОписаниеПоказателя.Наименование = НСтр("ru='Тарифная ставка по должности (часовая)';uk='Тарифна ставка за посадою (годинна)'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Час. тариф по долж.';uk='Год. тариф за пос.'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
		ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;
		ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
...
Процедура СоздатьПоказательДневнойТарифПоДолжности(ПараметрыПланаВидовРасчета = Неопределено) Экспорт
	...
	ОписаниеПоказателя.Наименование = НСтр("ru='Тарифная ставка по должности (дневная)';uk='Тарифна ставка за посадою (денна)'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Днев. тариф по долж.';uk='Ден. тариф за посад.'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
	ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;
	ОписаниеПоказателя.ВидТарифнойСтавки = Перечисления.ВидыТарифныхСтавок.ДневнаяТарифнаяСтавка;
	ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
...
Процедура СоздатьПоказательБазовыйТарифГруппы(НастройкиРасчетаЗарплаты = Неопределено) Экспорт
	...
	Если НастройкиРасчетаЗарплаты.ИспользоватьТарифныеСеткиПриРасчетеЗарплаты Тогда
		...
		ОписаниеПоказателя.Наименование = НСтр("ru='Базовый тариф группы';uk='Базовий тариф групи'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Баз. тариф группы';uk='Баз. тариф групи'",Локализация.КодЯзыкаИнформационнойБазы());
...
Функция СоздатьПоказательДоплатаЗаРаботуВНочноеВремя() Экспорт
	...
	ОписаниеПоказателя.Наименование = НСтр("ru='Процент доплаты за работу в ночное время';uk='Відсоток доплати за роботу в нічний час'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='% допл. за ночн.';uk='% допл. за нічн.'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.НазначениеПоказателя = Перечисления.НазначенияПоказателейРасчетаЗарплаты.ДляОрганизации;
	ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
	Возврат ЗаписатьПоказатель(ОписаниеПоказателя);
...
Функция СоздатьПоказательДоплатаЗаРаботуВВечернееВремя() Экспорт
	...
	ОписаниеПоказателя.Наименование = НСтр("ru='Процент доплаты за работу в вечернее время';uk='Відсоток доплати за роботу у вечірній час'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='% допл. за вечерн.';uk='% допл. за вечірн.'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.НазначениеПоказателя = Перечисления.НазначенияПоказателейРасчетаЗарплаты.ДляОрганизации;
	ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
	Возврат ЗаписатьПоказатель(ОписаниеПоказателя);
...
Процедура СоздатьПоказательКоэффициентИндексацииСреднегоЗаработка() Экспорт
	...
	ОписаниеПоказателя.Наименование = НСтр("ru='Коэффициент индексации среднего заработка';uk='Коефіцієнт індексації середнього заробітку'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Коэф. индекс. средн.';uk='Коеф. індекс. середн.'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.Точность = 2;
	ЗаписатьПоказатель(ОписаниеПоказателя);
...
Процедура СоздатьПоказательНатуральныйДоход() Экспорт
	...
	ОписаниеПоказателя.Наименование = НСтр("ru='Натуральный доход';uk='Натуральний дохід'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Натур. доход';uk='Натур. дохід'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
	ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;
	ОписаниеПоказателя.Точность = 0;
	ЗаписатьПоказатель(ОписаниеПоказателя);
...
Функция СоздатьПоказательСтоимостьДняЧаса() Экспорт
	...
	ОписаниеПоказателя.Наименование = НСтр("ru='Стоимость часа (или дня)';uk='Вартість години (або дня)'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Час. или дн. стоим.';uk='Год. або дн. варт.'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.Точность = 3;
	Возврат ЗаписатьПоказатель(ОписаниеПоказателя);
...
Функция СоздатьПоказательСреднечасовойЗаработок() Экспорт
	...
	ОписаниеПоказателя.Наименование = НСтр("ru='Среднечасовой заработок';uk='Середньогодинний заробіток'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Ср. час. заработок';uk='Сер. год. заробіток'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.Точность = 2;
	Возврат ЗаписатьПоказатель(ОписаниеПоказателя);
...
Функция СоздатьПоказательСреднедневнойЗаработок() Экспорт
	...
	ОписаниеПоказателя.Наименование = НСтр("ru='Среднедневной заработок';uk='Середньоденний заробіток'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Ср. дн. заработок';uk='Сер. дн. заробіток'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.Точность = 2;
	Возврат ЗаписатьПоказатель(ОписаниеПоказателя);
...
Функция СоздатьПоказательНадбавкаЗаВыслугуЛет() Экспорт
	...
	ОписаниеПоказателя.Наименование = НСтр("ru='Процент надбавки за выслугу лет';uk='Відсоток надбавки за вислугу років'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='% надб.';uk='% надб.'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;
	ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
	ОписаниеПоказателя.Точность = 2;
...
Процедура СоздатьПоказательНормаДней()
	...
	ОписаниеПоказателя.Наименование = НСтр("ru='Норма дней';uk='Норма днів'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Норма (дн.)';uk='Норма (дн.)'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.ОтображатьВДокументахНачисления = Ложь;
	ЗаписатьПоказатель(ОписаниеПоказателя);
...
Функция ОписаниеПоказателяДоляНеполногоРабочегоВремени()
	...
	ОписаниеПоказателя.Наименование = НСтр("ru='Доля неполного рабочего времени';uk='Частка неповного робочого часу'",Локализация.КодЯзыкаИнформационнойБазы());
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Доля неполн. времени';uk='Частка неповн. часу'",Локализация.КодЯзыкаИнформационнойБазы());
...
Процедура СоздатьПоказателиСуммированногоУчета() Экспорт
	...
	Если ИспользоватьУчетВремениСотрудниковВЧасах И ИспользоватьОплатуПереработокСуммированногоУчета Тогда
		...
		ОписаниеПоказателя.Наименование = НСтр("ru='Переработано по суммированному учету';uk='Перероблено за підсумованим обліком'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Переработки (всего)';uk='Переробітки (всього)'",Локализация.КодЯзыкаИнформационнойБазы());
		ЗаписатьПоказатель(ОписаниеПоказателя);
		// Переработки в пределах 2 часов.
		ОписаниеПоказателя = ОписаниеПоказателя();
		ОписаниеПоказателя.Идентификатор = "ПереработаноПоСуммированномуУчетуВПределах2Часов";
		ОписаниеПоказателя.Наименование = НСтр("ru='Переработано по суммированному учету в пределах 2 часов';uk='Перероблено за підсумованим обліком в межах 2 годин'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Переработки (до 2 ч)';uk='Переробітки (до 2 год)'",Локализация.КодЯзыкаИнформационнойБазы());
		ЗаписатьПоказатель(ОписаниеПоказателя);
	Иначе
...
Процедура ВыполнитьПереименованиеПоказателейУчетаВремени() Экспорт
	...
	Если ЗначениеЗаполнено(ПоказательНормаДнейПоГрафикуПолногоРабочегоВремени) Тогда
		...
		Если ПоказательНормаДнейПоГрафикуПолногоРабочегоВремени.Идентификатор = "НормаВремениВДнях" Тогда
			...
			ПоказательОбъект.Наименование = НСтр("ru='Норма дней по графику полного рабочего времени';uk='Норма днів за графіком повного робочого часу'",Локализация.КодЯзыкаИнформационнойБазы());
			ПоказательОбъект.КраткоеНаименование = НСтр("ru='Норма дн. полн.граф.';uk='Норма дн. повн.граф.'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Если ЗначениеЗаполнено(ПоказательНормаЧасов) Тогда
		...
		Если ПоказательНормаЧасов.Идентификатор = "НормаВремениВЧасах" Тогда
			...
			ПоказательОбъект.Наименование = НСтр("ru='Норма часов';uk='Норма годин'",Локализация.КодЯзыкаИнформационнойБазы());
...
Процедура СоздатьПоказателиДляНадбавок(ПараметрыПланаВидовРасчета)
	...
	Если ПрочиеНадбавкиПроцентом.Количество() > 0 Тогда
		...
		Для каждого Надбавка Из ПрочиеНадбавкиПроцентом Цикл
			...
			Наименование = НСтр("ru='Процент надбавки';uk='Відсоток надбавки'",Локализация.КодЯзыкаИнформационнойБазы()) + " " + Надбавка;
			
			Идентификатор = НСтр("ru='ПроцентНадбавки';uk='ПроцентНадбавки'",Локализация.КодЯзыкаИнформационнойБазы());
			КраткоеНаименование = "% ";
	...
	Если ПрочиеНадбавкиСуммой.Количество() > 0 Тогда
		...
		Для каждого Надбавка Из ПрочиеНадбавкиСуммой Цикл
			...
			Надбавка = СОКРЛП(Надбавка);
			Наименование = Надбавка + " " + НСтр("ru='(грн)';uk='(грн)'",Локализация.КодЯзыкаИнформационнойБазы());
			...
			КраткоеНаименование = КраткоеНаименование + " " + НСтр("ru='(грн)';uk='(грн)'",Локализация.КодЯзыкаИнформационнойБазы());
...
Процедура СоздатьПоказателиДляКомпенсационныхВыплат(ПараметрыПланаВидовРасчета)
	...
	Если КомпенсационныеВыплаты.Количество() > 0 Тогда
		...
		Для каждого Выплата Из КомпенсационныеВыплаты Цикл
			...
			Наименование = Название + " " + НСтр("ru='(грн)';uk='(грн)'",Локализация.КодЯзыкаИнформационнойБазы());
...
Процедура СоздатьПоказателиДляУчетаВремениСотрудниковВЧасах(НастройкиРасчетаЗарплаты, ПараметрыПланаВидовРасчета)
	...
	Если НастройкиРасчетаЗарплаты.ИспользоватьУчетВремениСотрудниковВЧасах Тогда
		...
		ОписаниеПоказателя.Наименование = НСтр("ru='Время в часах';uk='Час в годинах'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.ОтображатьВДокументахНачисления = Ложь;
		ОписаниеПоказателя.Точность = 3;
		ЗаписатьПоказатель(ОписаниеПоказателя);
	Иначе
	...
	Если НастройкиРасчетаЗарплаты.ИспользоватьУчетВремениСотрудниковВЧасах 
		...
		ОписаниеПоказателя.Наименование = НСтр("ru='Тарифная ставка (часовая)';uk='Тарифна ставка (годинна)'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Час. тариф';uk='Год. тариф'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
		ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;
		ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
		ОписаниеПоказателя.Точность = ПараметрыПоказателей.ОкладТарифЧасовойТочность;
		...
		ОписаниеПоказателя.Наименование = НСтр("ru='Норма часов';uk='Норма годин'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Норма (час.)';uk='Норма (год.)'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.ОтображатьВДокументахНачисления = Ложь;
		ЗаписатьПоказатель(ОписаниеПоказателя);
		
		ОписаниеПоказателя = ОписаниеПоказателя();
		ОписаниеПоказателя.Идентификатор = "ОтработаноЧасов";
		ОписаниеПоказателя.Наименование = НСтр("ru='Отработано часов, в т.ч. сверхурочно';uk='Відпрацьовано годин, в т. ч. понаднормово'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Отраб. (час.)';uk='Відпрац. (год.)'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.ОтображатьВДокументахНачисления = Ложь;
		ОписаниеПоказателя.Точность = 3;
		ЗаписатьПоказатель(ОписаниеПоказателя);
	...
	Если НастройкиРасчетаЗарплаты.ИспользоватьУчетВремениСотрудниковВЧасах 
		...
		ОписаниеПоказателя.Наименование = НСтр("ru='Размер часовой доплаты за квалификацию';uk='Розмір годинної доплати за кваліфікацію'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru='Час. допл. за квалиф.';uk='Год. допл. за кваліф.'",Локализация.КодЯзыкаИнформационнойБазы());
		ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
		ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;
		ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
		ОписаниеПоказателя.Точность = ПараметрыПоказателей.ОкладТарифТочность;
