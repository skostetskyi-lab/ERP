...
Процедура ОбновитьПолеЗабронированОрганизацией()
	...
	ДанныеБронирования = РегистрыСведений.БронированиеСотрудников.ПолучитьПоследнее(, СтруктураОтбора);
	ЗабронированОрганизацией = 	ДанныеБронирования.Организация;
	ЗабронированСрок = ДанныеБронирования.СрокБронирования;
...
&НаКлиенте
Процедура ВоинскийУчетЗабронированСтороннейОрганизациейПриИзменении(Элемент)
	УстановитьДоступностьЭлементов();
	Если НЕ ВоинскийУчет.ЗабронированСтороннейОрганизацией Тогда
		ВоинскийУчет.ЗабронированСтороннейОрганизациейСрок = Неопределено;
	КонецЕсли;	
КонецПроцедуры
...
Процедура УстановитьДоступностьЭлементов()
    ...
    ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ВоинскийУчетЗабронированСтороннейОрганизациейСрок", "Доступность", ВоинскийУчет.ЗабронированСтороннейОрганизацией);
