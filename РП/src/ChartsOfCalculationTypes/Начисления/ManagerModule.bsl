...
Процедура СоздатьНачисленияПоНастройкам(ПараметрыПланаВидовРасчета = Неопределено, НачальноеЗаполнение = Ложь) Экспорт
	...
	Если НачальноеЗаполнение Тогда
		...
		Описание.Код					= НСтр("ru='ОКЛ';uk='ОКЛ'",Локализация.КодЯзыкаИнформационнойБазы());
		Описание.Наименование			= НСтр("ru='Оплата по окладу';uk='Оплата по окладу'",Локализация.КодЯзыкаИнформационнойБазы());
		Описание.КраткоеНаименование 	= НСтр("ru='Оклад';uk='Оклад'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПовременнаяОплатаТруда;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ТРФД';uk='ТРФД'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Оплата по дневному тарифу';uk='Оплата за денним тарифом'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Опл. по дням';uk='Опл. по днях'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.ВидВремени 			= Перечисления.ВидыРабочегоВремениСотрудников.ОтработанноеВПределахНормы;
	...
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='СОВМ';uk='СУМЩ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Доплата за совмещение должностей, исполнение обязанностей';uk='Доплата за суміщення посад, виконання обов''язків'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Совмещение';uk='Суміщення'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ДПСРЗ';uk='ДПСРЗ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Доплата до среднего заработка';uk='Доплата до середнього заробітку'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Допл. до среднего';uk='Допл. до середнього'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ДПФСС';uk='ДПФСС'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Доплата за дни болезни';uk='Доплата за дні хвороби'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Допл. за дни болезни';uk='Допл. за дні хвороби'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.НачисляетсяПриРасчетеПервойПоловиныМесяца = Ложь;
	...
	Если НачальноеЗаполнение Тогда
		...
		Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
		Описание.Код					= НСтр("ru='БЛН';uk='ЛКР'",Локализация.КодЯзыкаИнформационнойБазы());
		Описание.Наименование			= НСтр("ru='Больничный';uk='Лікарняний'",Локализация.КодЯзыкаИнформационнойБазы());
		Описание.КраткоеНаименование 	= НСтр("ru='Больничный';uk='Лікарняний'",Локализация.КодЯзыкаИнформационнойБазы());
		СоздатьИзменитьНачисленияПоОписанию(КоллекторНачислений, Описание,,ПараметрыПланаВидовРасчета.НачальнаяНастройкаПрограммы);
		...
		Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
		Описание.Код					= НСтр("ru='БЛРДТ';uk='ЛКРДТ'",Локализация.КодЯзыкаИнформационнойБазы());
		Описание.Наименование			= НСтр("ru='Больничный за счет работодателя';uk='Лікарняний за рахунок роботодавця'",Локализация.КодЯзыкаИнформационнойБазы());
		Описание.КраткоеНаименование 	= НСтр("ru='Больн. (работодат.)';uk='Лікарн. (роботодав.)'",Локализация.КодЯзыкаИнформационнойБазы());
		СоздатьИзменитьНачисленияПоОписанию(КоллекторНачислений, Описание,,ПараметрыПланаВидовРасчета.НачальнаяНастройкаПрограммы);
		...
		Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
		Описание.Код					= НСтр("ru='ОТБРР';uk='ОТВП'",Локализация.КодЯзыкаИнформационнойБазы());
		Описание.Наименование			= НСтр("ru='Отпуск по беременности и родам';uk='Відпустка у зв''язку з вагітністю та пологами'",Локализация.КодЯзыкаИнформационнойБазы());
		Описание.КраткоеНаименование 	= НСтр("ru='Отп. по берем.';uk='Відп. по вагітн.'",Локализация.КодЯзыкаИнформационнойБазы());
		СоздатьИзменитьНачисленияПоОписанию(КоллекторНачислений, Описание,,ПараметрыПланаВидовРасчета.НачальнаяНастройкаПрограммы);
		...
		Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
		Описание.Код					= НСтр("ru='БЛТП';uk='ЛКТВ'",Локализация.КодЯзыкаИнформационнойБазы());
		Описание.Наименование			= НСтр("ru='Больничный при травме на производстве';uk='Лікарняний при травмі на виробництві'",Локализация.КодЯзыкаИнформационнойБазы());
		Описание.КраткоеНаименование 	= НСтр("ru='Больн. при травме';uk='Лікарн. при травмі'",Локализация.КодЯзыкаИнформационнойБазы());
		СоздатьИзменитьНачисленияПоОписанию(КоллекторНачислений, Описание,,ПараметрыПланаВидовРасчета.НачальнаяНастройкаПрограммы);
		...
		Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
		Описание.Код					= НСтр("ru='БЛПЗ';uk='ЛКПЗ'",Локализация.КодЯзыкаИнформационнойБазы());
		Описание.Наименование			= НСтр("ru='Больничный при профзаболевании';uk='Лікарняний при профзахворюванні'",Локализация.КодЯзыкаИнформационнойБазы());
		Описание.КраткоеНаименование 	= НСтр("ru='Больн. при профзаб.';uk='Лік. при профзахв.'",Локализация.КодЯзыкаИнформационнойБазы());
		СоздатьИзменитьНачисленияПоОписанию(КоллекторНачислений, Описание,,ПараметрыПланаВидовРасчета.НачальнаяНастройкаПрограммы);
		...
		Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
		Описание.Код					= НСтр("ru='ОБ';uk='ВХВ'",Локализация.КодЯзыкаИнформационнойБазы());
		Описание.Наименование			= НСтр("ru='Отсутствие по болезни';uk='Відсутність по хворобі'",Локализация.КодЯзыкаИнформационнойБазы());
		Описание.КраткоеНаименование 	= НСтр("ru='Неявка по болезни';uk='Неявка по хворобі'",Локализация.КодЯзыкаИнформационнойБазы());
		СоздатьИзменитьНачисленияПоОписанию(КоллекторНачислений, Описание,,ПараметрыПланаВидовРасчета.НачальнаяНастройкаПрограммы);
		...
		Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
		Описание.Код					= НСтр("ru='ОББР';uk='ВБВП'",Локализация.КодЯзыкаИнформационнойБазы());
		Описание.Наименование			= НСтр("ru='Неоплачиваемые дни отпуска по беременности и родам';uk='Неоплачувані дні відпустки по вагітності і пологах'",Локализация.КодЯзыкаИнформационнойБазы());
		Описание.КраткоеНаименование 	= НСтр("ru='Отп. по берем. без опл.';uk='Відп. пл вагітн. без опл.'",Локализация.КодЯзыкаИнформационнойБазы());
		СоздатьИзменитьНачисленияПоОписанию(КоллекторНачислений, Описание,,ПараметрыПланаВидовРасчета.НачальнаяНастройкаПрограммы);
		...
		Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
		Описание.Наименование			= НСтр("ru='Компенсация при увольнении (выходное пособие)';uk='Компенсація при звільненні (вихідна допомога)'",Локализация.КодЯзыкаИнформационнойБазы());
		Описание.КраткоеНаименование 	= НСтр("ru='Выходн. пособие';uk='Вихідн. допомога'",Локализация.КодЯзыкаИнформационнойБазы());
		Описание.Код 					= НСтр("ru='КПУ';uk='КПЗ'",Локализация.КодЯзыкаИнформационнойБазы());
		СоздатьИзменитьНачисленияПоОписанию(КоллекторНачислений, Описание,,ПараметрыПланаВидовРасчета.НачальнаяНастройкаПрограммы);
	КонецЕсли;
	...
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='КОМНД';uk='ВІДР'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Командировка';uk='Відрядження'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Командировка';uk='Відрядження'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ОТПОЗ';uk='ВДПОЗ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Отпуск без оплаты согласно КЗОТ';uk='Відпустка без оплати згідно КЗПП'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Отп. без опл.';uk='Відп. без опл.'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОтпускБезОплаты;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ОТПДО';uk='ВДПБО'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Отпуск за свой счет';uk='Відпустка за свій рахунок'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Отп. за свой счет';uk='Відп. за свій рахунок'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОтпускБезОплаты;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ОТПВП';uk='ВДПВС'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Отпуск без оплаты на время военного положения';uk='Відпустка без оплати на час воєнного стану'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Отп. без опл. ВП';uk='Відп. без. опл. ВС'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.ОбозначениеВТабелеУчетаРабочегоВремени	= ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыИспользованияРабочегоВремени.НеоплачиваемыйОтпускПоЗаконодательству");
	...
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='УЧЕБН';uk='НАВЧ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Дополнительный учебный отпуск (оплачиваемый)';uk='Додаткова навчальна відпустка (оплачувана)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Учебн. отп.';uk='Навч. відп.'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОтпускБезОплаты;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ОТПУД';uk='ВДПНД'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Дополнительный учебный отпуск без оплаты';uk='Додаткова навчальна відпустка без оплати'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Учебн. отп. без опл.';uk='Навч. відп. без опл.'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаОтпуска;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ДОЧАЭС';uk='ДВЧАЕС'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Дополнительный отпуск пострадавшим в аварии на ЧАЭС';uk='Додаткова відпустка постраждалим в аварії на ЧАЕС'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Доп. отп. ЧАЭС';uk='Дод. відп. ЧАЕС'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='НЕВЫХ';uk='НЕВИХ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Отсутствие по невыясненной причине';uk='Відсутність з нез''ясованої причини'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Неявка';uk='Неявка'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='МОББО';uk='МОББО'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Мобилизация без оплаты';uk='Мобілізація без оплати'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Моб. без опл.';uk='Моб. без опл.'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ПРГУЛ';uk='ПРГУЛ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Прогул';uk='Прогул'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Прогул';uk='Прогул'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ОТГУЛ';uk='ВІДГЛ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Отгул';uk='Відгул'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Отгул';uk='Відгул'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='МАТПМ';uk='МАТДП'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Материальная помощь (не целевая)';uk='Матеріальна допомога (не цільова)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Мат. пом.';uk='Мат. доп.'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.МатериальнаяПомощь;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='МТПМР';uk='МТДПР'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Материальная помощь (целевая)';uk='Матеріальна допомога (цільова)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Мат. пом. (цел.)';uk='Мат. доп. (ціл.)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.ФормулаРасчета = "";
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.МатериальнаяПомощь;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='МТПМН';uk='МТДПН'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Материальная помощь, не облагаемая налогами';uk='Матеріальна допомога, що не оподатковується'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Мат. пом. не обл. нал.';uk='Мат. доп. не оподат.'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.ФормулаРасчета = "";
	...
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='МТПОМ';uk='МТДОП'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Материальная помощь к отпуску';uk='Матеріальна допомога до відпустки'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Мат. пом. к отп.';uk='Мат. доп. до отп.'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ДОНОР';uk='ДОНОР'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Оплата за дни сдачи крови и ее компонентов';uk='Оплата за дні здачі крові та її компонентів'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Донорство';uk='Донорство'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.ОбозначениеВТабелеУчетаРабочегоВремени	= ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыИспользованияРабочегоВремени.ГосударственныеОбязанности");
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПовременнаяОплатаТруда;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ЕДВР';uk='ОДНР'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Единовременное начисление';uk='Одноразове нарахування'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Единовр. начисл.';uk='Однораз. нарах.'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.ФормулаРасчета 		= "";
	...
	Если НачальноеЗаполнение Тогда
		...
		Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
		Описание.Код					= НСтр("ru='РЕБ6';uk='ДИТ6'",Локализация.КодЯзыкаИнформационнойБазы());
		Описание.Наименование			= НСтр("ru='Отпуск по уходу за ребенком до шести лет';uk='Відпустка по догляду за дитиною до шести років'",Локализация.КодЯзыкаИнформационнойБазы());
		Описание.КраткоеНаименование 	= НСтр("ru='Уход за реб. до 6';uk='Догляд за дит. до 6'",Локализация.КодЯзыкаИнформационнойБазы());
		СоздатьИзменитьНачисленияПоОписанию(КоллекторНачислений, Описание,,ПараметрыПланаВидовРасчета.НачальнаяНастройкаПрограммы);
		...
		Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
		Описание.Код					= НСтр("ru='РЕБ3';uk='ДИТ3'",Локализация.КодЯзыкаИнформационнойБазы());
		Описание.Наименование			= НСтр("ru='Отпуск по уходу за ребенком до трех лет';uk='Відпустка по догляду за дитиною до трьох років'",Локализация.КодЯзыкаИнформационнойБазы());
		Описание.КраткоеНаименование 	= НСтр("ru='Уход за реб. до 3';uk='Догляд за дит. до 3'",Локализация.КодЯзыкаИнформационнойБазы());
		СоздатьИзменитьНачисленияПоОписанию(КоллекторНачислений, Описание,,ПараметрыПланаВидовРасчета.НачальнаяНастройкаПрограммы);
	КонецЕсли;
	...
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='СДЛОК';uk='ВДРОК'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Сдельный заработок (для работающих по окладу)';uk='Відрядний заробіток (для працюючих за окладом)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Сдельно';uk='Відрядно'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ИНД';uk='ІНД'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Индексация зарплаты';uk='Індексація зарплати'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Индексация';uk='Індексація'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ДМЗП';uk='ДМЗП'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Доплата до МЗП';uk='Доплата до МЗП'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Доплата до МЗП';uk='Доплата до МЗП'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.ВидВремени = Перечисления.ВидыРабочегоВремениСотрудников.ДополнительноОплачиваемоеВПределахНормы;
	Описание.КлючевыеСвойства = "КатегорияНачисленияИлиНеоплаченногоВремени";
	СоздатьИзменитьНачисленияПоОписанию(КоллекторНачислений, Описание,,ПараметрыПланаВидовРасчета.НачальнаяНастройкаПрограммы, НЕ НачальноеЗаполнение);
...
Процедура СоздатьНачисленияПростоев(ПараметрыПланаВидовРасчета, КоллекторНачислений = Неопределено, НастройкиРасчетаЗарплаты = Неопределено, СвойстваНачислений = Неопределено)
	...
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ПРОВР';uk='ПРОВР'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Простой по вине работника';uk='Простій з вини працівника'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Простой без опл.';uk='Простій без опл.'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ПРТД';uk='ПРТД'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Простой с приостановкой труд. дог.';uk='Простій з призупиненням труд. дог.'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Приост. труд. дог.';uk='Призуп. труд. дог.'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ПРОКД';uk='ПРОКД'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Оплата простоя по независящим от работодателя причинам';uk='Оплата простою з незалежних від роботодавця причин'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Простой незав. прич.';uk='Простій незал. обстав.'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ПРСРД';uk='ПРСРД'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Оплата простоя по вине работодателя';uk='Оплата простою з вини роботодавця'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Простой по вине работод.';uk='Простій з вини роботод.'",Локализация.КодЯзыкаИнформационнойБазы());
...
Процедура СоздатьНачислениеКомпенсацииОтпуска(ПараметрыПланаВидовРасчета, ВидОтпуска, НаименованиеОтпуска, КоллекторНачислений = Неопределено, КоллекторУдержаний = Неопределено, СвойстваНачислений = Неопределено, ДенежноеСодержание = Ложь, ДополнениеКода = Неопределено) Экспорт
	...
	КонецЕсли;
	Описание.СвойстваПоКатегории = СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Наименование = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Компенсация отпуска (%1)';uk='Компенсація відпустки (%1)'",Локализация.КодЯзыкаИнформационнойБазы()), НаименованиеОтпуска); 
	Описание.Код = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='КОТ%1';uk='КВД%1'",Локализация.КодЯзыкаИнформационнойБазы()), ДополнениеКодаКомпенсацииУдержания);
	Описание.ВидОтпуска = ВидОтпуска;
	Описание.КлючевыеСвойства = "ВидОтпуска,КатегорияНачисленияИлиНеоплаченногоВремени";
	СоздатьИзменитьНачисленияПоОписанию(КоллекторНачислений, Описание,,ПараметрыПланаВидовРасчета.НачальнаяНастройкаПрограммы);
...
Процедура СоздатьНачислениеОплатаДнейУходаЗаДетьмиИнвалидами(ПараметрыПланаВидовРасчета, КоллекторНачислений = Неопределено, СвойстваНачислений = Неопределено) Экспорт 
	...
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ИНВ';uk='ІНВ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Оплата дней ухода за детьми-инвалидами';uk='Оплата днів догляду за дітьми-інвалідами'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Уход за детьми-инв.';uk='Догляд за дітьми-інв.'",Локализация.КодЯзыкаИнформационнойБазы());
	СоздатьИзменитьНачисленияПоОписанию(КоллекторНачислений, Описание,,ПараметрыПланаВидовРасчета.НачальнаяНастройкаПрограммы);
...
Процедура СоздатьНачислениеНадбавкаЗаВредность(ПараметрыПланаВидовРасчета, КоллекторНачислений = Неопределено, СвойстваНачислений = Неопределено, НастройкиРасчетаЗарплаты = Неопределено) Экспорт
	...
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='НВР';uk='НШК'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Надбавка за вредные условия труда';uk='Надбавка за шкідливі умови праці'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Вредность';uk='Шкідливість'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.ФормулаРасчета 		= "ПроцентНадбавкиЗаВредность / 100 * РасчетнаяБаза";
	Описание.ВидВремени 			= Перечисления.ВидыРабочегоВремениСотрудников.ДополнительноОплачиваемоеВПределахНормы;
	Описание.НачисляетсяПриРасчетеПервойПоловиныМесяца = Истина;
...
Процедура СоздатьНачисленияНадбавки(КоллекторНачислений, СвойстваНачислений, ПараметрыПланаВидовРасчета)
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПовременнаяОплатаТруда;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='НВЛ';uk='НВР'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Надбавка за выслугу лет';uk='Надбавка за вислугу років'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Выслуга лет';uk='Вислуга років'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Если ПрочиеНадбавкиПроцентом.Количество() > 0 Тогда
		...
		Для Сч = 1 По ПрочиеНадбавкиПроцентом.Количество() Цикл
			...
			Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПовременнаяОплатаТруда;
			Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
			Описание.Код					= НСтр("ru='ПРН';uk='ПРН'",Локализация.КодЯзыкаИнформационнойБазы()) + ?(Индекс = 0,"", Индекс);
	...
	Если ПрочиеНадбавкиСуммой.Количество() > 0 Тогда
		...
		Для Сч = 1 По ПрочиеНадбавкиСуммой.Количество() Цикл
			...
			Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПовременнаяОплатаТруда;
			Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
			Описание.Код					= НСтр("ru='НСУМ';uk='НСУМ'",Локализация.КодЯзыкаИнформационнойБазы()) + ?(Индекс = 0,"", Индекс);
			Описание.Наименование			= Надбавка;
...
Процедура СоздатьНачислениеДоплатаЗаПереработкиПоСуммированномуУчету(ПараметрыПланаВидовРасчета, КоллекторНачислений = Неопределено, СвойстваНачислений = Неопределено, НастройкиРасчетаЗарплаты = Неопределено) Экспорт
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПовременнаяОплатаТруда;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ПРБТС';uk='ПРБТС'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Доплата за переработки при суммированном учете рабочего времени';uk='Доплата за переробітки при підсумованому обліку робочого часу'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Переработки при сумм. учете';uk='Переробітки за підсум. обліку'",Локализация.КодЯзыкаИнформационнойБазы());
...
Процедура СоздатьНачисленияКомпенсационныеВыплаты(КоллекторНачислений, СвойстваНачислений, ПараметрыПланаВидовРасчета)
	...
	Если КомпенсационныеВыплаты.Количество() > 0 Тогда
		...
		Для каждого Выплата Из КомпенсационныеВыплаты Цикл
			...
			Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
			Описание.Код					= НСтр("ru='КМПВ';uk='КМПВ'",Локализация.КодЯзыкаИнформационнойБазы());
...
Процедура СоздатьНачисленияНатуральныеДоходы(КоллекторНачислений, СвойстваНачислений, ПараметрыПланаВидовРасчета, НастройкиРасчетаЗарплаты)
	...
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='НТОПЛ';uk='НТОПЛ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Оплата в натуральной форме';uk='Оплата в натуральній формі'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Оплата в натур. форме';uk='Оплата в натур. формі'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Если СписокНатуральныхДоходов.Количество() > 0 Тогда
		...
		Для Сч = 1 По СписокНатуральныхДоходов.Количество() Цикл
			...
			Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ДоходВНатуральнойФорме;
			Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
			Описание.Код					= СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='НТ%1';uk='НТ%1'",Локализация.КодЯзыкаИнформационнойБазы()), Формат(Сч, "ЧЦ=3; ЧВН="));
	...
	Иначе
		...
		Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ДоходВНатуральнойФорме;
		Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
		Описание.Код					= НСтр("ru='НАТДХ';uk='НАТДХ'",Локализация.КодЯзыкаИнформационнойБазы()) + ?(Индекс = 0,"", Индекс);
		Описание.Наименование			= НСтр("ru='Натуральный доход';uk='Натуральний дохід'",Локализация.КодЯзыкаИнформационнойБазы());
		Описание.КраткоеНаименование 	= НСтр("ru='Натур. доход';uk='Натур. дохід'",Локализация.КодЯзыкаИнформационнойБазы());
		Описание.ФормулаРасчета 		= "";
		Описание.Рассчитывается 		= Ложь;
		Описание.ВидВремени 			= Перечисления.ВидыРабочегоВремениСотрудников.ДополнительноОплачиваемоеВПределахНормы;
		Описание.КлючевыеСвойства 		= "КатегорияНачисленияИлиНеоплаченногоВремени";
...
Процедура СоздатьНачисленияПремий(КоллекторНачислений, СвойстваНачислений, ПараметрыПланаВидовРасчета)
	...
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ПРЕМП';uk='ПРЕМВ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Премия ежемесячная процентом';uk='Премія щомісячна відсотком'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Премия мес.';uk='Премія міс.'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.Премия;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ПРЕМС';uk='ПРЕМС'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Премия ежемесячная суммой';uk='Премія щомісячна сумою'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Премия мес.';uk='Премія міс.'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.Премия;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ПРГП';uk='ПРРВ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Премия за год (процентом)';uk='Премія за рік (відсотком)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Премия год.';uk='Премія річн.'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.Премия;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ПРГС';uk='ПРРС'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Премия за год (суммой)';uk='Премія за рік (сумою)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Премия год.';uk='Премія річн.'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.Премия;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ПРКП';uk='ПРКВ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Премия за квартал (процентом)';uk='Премія за квартал (відсотком)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Премия кварт.';uk='Премія кварт.'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.Премия;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ПРКС';uk='ПРКС'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Премия за квартал (суммой)';uk='Премія за квартал (сумою)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Премия кварт.';uk='Премія кварт.'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.Премия;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ПРРП';uk='ПРОВ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Премия разовая (процентом)';uk='Разова премія (відсотком)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Премия разов.';uk='Премія разов.'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.Премия;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ПРРС';uk='ПРОС'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Премия разовая (суммой)';uk='Разова премія (сумою)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Премия разов.';uk='Премія разов.'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.Премия;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ДПВРЧ';uk='ДПВРЧ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Доплата за выручку от реализации';uk='Доплата за виторг від реалізації'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Допл. от реализ.';uk='Допл. від реаліз.'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.Премия;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ДППЛН';uk='ДППЛН'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Доплата за выполнение плана';uk='Доплата за виконання плану'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Допл. за выполн. плана';uk='Допл. за викон. плану'",Локализация.КодЯзыкаИнформационнойБазы());
...
Процедура СоздатьНачисленияЕжегодногоОтпуска(ПараметрыПланаВидовРасчета, КоллекторНачислений, КоллекторУдержаний, СвойстваНачислений) 
	...
	НаименованиеОтпуска  		= НСтр("ru='Отпуск основной';uk='Основна відпустка'",Локализация.КодЯзыкаИнформационнойБазы());
	КраткоеНаименование 		= НСтр("ru='Отпуск';uk='Відпустка'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	НаименованиеОтпуска  		= НСтр("ru='Отпуск дополнительный';uk='Відпустка додаткова'",Локализация.КодЯзыкаИнформационнойБазы());
	КраткоеНаименование 		= НСтр("ru='Отпуск дополнительный';uk='Відпустка додаткова'",Локализация.КодЯзыкаИнформационнойБазы());
	СоздаватьКомпенсацию  		= Истина;
	СоздатьНачисленияОтпускаИКомпенсации(ПараметрыПланаВидовРасчета, ВидОтпуска, НаименованиеОтпуска, Истина, СоздаватьКомпенсацию, КоллекторНачислений, КоллекторУдержаний, СвойстваНачислений, , КраткоеНаименование);
	
	ВидОтпуска 					= ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыОтпусков.ДополнительныйНаДетей"); 
	НаименованиеОтпуска  		= НСтр("ru='Отпуск дополнительный на детей';uk='Відпустка додаткова на дітей'",Локализация.КодЯзыкаИнформационнойБазы());
	КраткоеНаименование 		= НСтр("ru='Отпуск на детей';uk='Відпустка на дітей'",Локализация.КодЯзыкаИнформационнойБазы());
	СоздаватьКомпенсацию  		= Истина;
	СоздатьНачисленияОтпускаИКомпенсации(ПараметрыПланаВидовРасчета, ВидОтпуска, НаименованиеОтпуска, Истина, СоздаватьКомпенсацию, КоллекторНачислений, КоллекторУдержаний, СвойстваНачислений, , КраткоеНаименование);

	ВидОтпуска 					= ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыОтпусков.ДополнительныйПрочий"); 
	НаименованиеОтпуска  		= НСтр("ru='Отпуск прочий';uk='Відпустка інша'",Локализация.КодЯзыкаИнформационнойБазы());
	КраткоеНаименование 		= НСтр("ru='Отпуск прочий';uk='Відпустка інша'",Локализация.КодЯзыкаИнформационнойБазы());
...
Процедура СоздатьНачисленияОтпускаНаСанаторноКурортноеЛечениеЗаСчетФСС(ПараметрыПланаВидовРасчета, КоллекторНачислений = Неопределено, КоллекторУдержаний = Неопределено, СвойстваНачислений = Неопределено) Экспорт 
	...
	Описание.СвойстваПоКатегории 						= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Наименование 								= НСтр("ru='Отпуск на период санаторно-курортного лечения (за счет ФСС)';uk='Відпустка на період санаторно-курортного лікування (за рахунок ФСС)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 						= НСтр("ru='Отпуск на СКЛ (ФСС)';uk='Відпустка на СКЛ (ФСС)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Код 										= НСтр("ru='СКЛ';uk='СКЛ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КлючевыеСвойства 							= "КатегорияНачисленияИлиНеоплаченногоВремени";
	СоздатьИзменитьНачисленияПоОписанию(КоллекторНачислений, Описание,,ПараметрыПланаВидовРасчета.НачальнаяНастройкаПрограммы);
...
Процедура СоздатьНачисленияГиг(КоллекторНачислений, СвойстваНачислений, НастройкиРасчетаЗарплаты, ПараметрыПланаВидовРасчета)
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПовременнаяОплатаТруда;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ОКГИГ';uk='ОКГІГ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Вознаграждение по гиг-контрактам: за месяц';uk='Винагорода за гіг-контрактами: за місяць'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Оклад-гиг';uk='Оклад-гіг'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.ФормулаРасчета			= "Оклад * ДоляНеполногоРабочегоВремени * ВремяВДнях / НормаДней";
	Описание.ВидВремени = Перечисления.ВидыРабочегоВремениСотрудников.ОтработанноеВПределахНормы;
	Описание.УчетВремениВЧасах		= Ложь;
	Описание.ОбозначениеВТабелеУчетаРабочегоВремени	= ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыИспользованияРабочегоВремени.РабочееВремя");
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПовременнаяОплатаТруда;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ТДГИГ';uk='ТДГІГ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Вознаграждение по гиг-контрактам: по дневному тарифу';uk='Винагорода за гіг-контрактами: за денним тарифом'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Опл. по дням (гиг)';uk='Опл. по днях (гіг)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.ВидВремени 			= Перечисления.ВидыРабочегоВремениСотрудников.ОтработанноеВПределахНормы;
	Описание.УчетВремениВЧасах		= Ложь;
	Описание.ФормулаРасчета			= "ТарифнаяСтавкаДневная * ВремяВДнях";
	Описание.ОбозначениеВТабелеУчетаРабочегоВремени	= ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыИспользованияРабочегоВремени.РабочееВремя");
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПовременнаяОплатаТруда;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ТЧГИГ';uk='ТГГІГ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Вознаграждение по гиг-контрактам: по часовому тарифу';uk='Винагорода за гіг-контрактами: за годинним тарифом'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Часовой тариф (гиг)';uk='Годинний тариф (гіг)'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаОтпуска; 
	Описание.СвойстваПоКатегории 	                    = СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					                    = НСтр("ru='ОПГИГ';uk='ОПГІГ	'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование		                    	= НСтр("ru='Оплачиваемый перерыв для гиг-специалистов';uk='Оплачувана перерва для гіг-фахівців'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	                    = НСтр("ru='Опл.перерыв(ГИГ)';uk='Опл.перерва (ГІГ)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.СпособРасчета = Перечисления.СпособыРасчетаНачислений.ПроизвольнаяФормула;
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаБольничногоЛиста;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='БЛГИГ';uk='ЛЛГІГ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Больничный для гиг-специалистов';uk='Лікарняний для гіг-фахівців'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Больничный (ГИГ)';uk='Лікарняний (ГІГ)'",Локализация.КодЯзыкаИнформационнойБазы());
	// свой ндфл
	Описание.КодДоходаНДФЛ          = Справочники.ВидыДоходовНДФЛ.Код127;
	Описание.КлючевыеСвойства       = "Код, КодДоходаНДФЛ";
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаБольничногоЛистаЗаСчетРаботодателя;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='БРГИГ';uk='ЛРГІГ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Больничный за счет работодателя для гиг-специалистов';uk='Лікарняний за рахунок роботодавця для гіг-фахівців'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Больн. (работодат. ГИГ)';uk='Лікарн. (роботодав. ГІГ)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КодДоходаНДФЛ          = Справочники.ВидыДоходовНДФЛ.Код127;
...
Процедура СоздатьНачисленияДляУчетаВремениСотрудниковВЧасах(КоллекторНачислений, СвойстваНачислений, НастройкиРасчетаЗарплаты, ПараметрыПланаВидовРасчета)
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПовременнаяОплатаТруда;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ОКЛЧС';uk='ОКЛГД'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Оплата по окладу (по часам)';uk='Оплата по окладу (по годинах)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Оклад (по часам)';uk='Оклад (по годинах)'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПовременнаяОплатаТруда;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ТРФЧС';uk='ТРФГД'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Оплата по часовому тарифу';uk='Оплата за годинним тарифом'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Часовой тариф';uk='Годинний тариф'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.ФормулаРасчета			= "ТарифнаяСтавкаЧасовая * ВремяВЧасах";
	Описание.ВидВремени 			= Перечисления.ВидыРабочегоВремениСотрудников.ОтработанноеВПределахНормы;
	Описание.ОбозначениеВТабелеУчетаРабочегоВремени	= ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыИспользованияРабочегоВремени.РабочееВремя");
	Описание.УчетВремениВЧасах		= Истина;
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.СдельнаяОплатаТруда;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='СДЛЧС';uk='ВДРГД'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Сдельный заработок (для работающих по часовому тарифу)';uk='Відрядний заробіток (для працюючих за годинним тарифом)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Сдельно (по часам)';uk='Відрядно (по годинах)'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПовременнаяОплатаТруда;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='НОЧН';uk='НІЧН'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Доплата за работу в ночное время';uk='Доплата за роботу в нічний час'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Ночные часы';uk='Нічні години'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПовременнаяОплатаТруда;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ПРНОЧ';uk='СВНІЧ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Доплата за работу в праздничные дни (ночное время)';uk='Доплата за роботу в святкові дні (нічний час)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Ночные часы (праздн.)';uk='Нічні години (святк.)'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПовременнаяОплатаТруда;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ВЕЧЕР';uk='ВЕЧІР'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Доплата за работу в вечернее время';uk='Доплата за роботу у вечірній час'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Вечерние часы';uk='Вечірні години'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПовременнаяОплатаТруда;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ПРВЕЧ';uk='СВВЕЧ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Доплата за работу в праздничные дни (вечернее время)';uk='Доплата за роботу в святкові дні (вечірній час)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Вечерние часы (праздн.)';uk='Вечірні години (святк.)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.ФормулаРасчета			= "СтоимостьЧаса * ВремяВЧасах";
	Описание.ВидВремени				= Перечисления.ВидыРабочегоВремениСотрудников.ДополнительноОплачиваемоеВПределахНормы;
	Описание.ОбозначениеВТабелеУчетаРабочегоВремени	= ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыИспользованияРабочегоВремени.РаботаВечерниеЧасы");
	Описание.СпособВыполненияНачисления = Перечисления.СпособыВыполненияНачислений.ЗаПраздничныеДниПриОкончательномРасчете;
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПовременнаяОплатаТруда;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='СВХУР';uk='НДУР'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Оплата сверхурочных часов';uk='Оплата понаднормових годин'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Сверхурочно';uk='Понаднормово'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПовременнаяОплатаТруда;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ПРОПЛ';uk='СВОПЛ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Оплата работы в праздничные и выходные дни';uk='Оплата роботи у святкові і вихідні дні'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Праздн. и выходн.';uk='Свят. і вихідн.'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПовременнаяОплатаТруда;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ПРДОП';uk='СВДОП'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Доплата за работу в праздничные дни (дневное время)';uk='Доплата за роботу в святкові дні (денний час)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Доплата праздн. и выходн.';uk='Доплата свят. та вихідн.'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПовременнаяОплатаТруда;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='СВУРН';uk='НДУРН'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Оплата сверхурочных часов без повышенной оплаты';uk='Оплата понаднормових годин без підвищеної оплати'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Сверхурочно норм.';uk='Понаднормово норм.'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПовременнаяОплатаТруда;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ПРОПН';uk='СВОПН'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Оплата работы в праздничные и выходные дни без повышенной оплаты';uk='Оплата роботи у святкові і вихідні дні без підвищеної оплати'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Праздн. и выходн. норм.';uk='Свят. і вихідн. норм.'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.ФормулаРасчета			= "ВремяВДняхЧасах * СтоимостьДняЧаса";
	Описание.ВидВремени				= Перечисления.ВидыРабочегоВремениСотрудников.ОтработанноеСверхНормы;
...
Процедура СоздатьНачислениеНадбавкаЗаКвалификационнуюКатегорию(ПараметрыПланаВидовРасчета, КоллекторНачислений, СвойстваНачислений, НастройкиРасчетаЗарплаты)
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПовременнаяОплатаТруда;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='НКК';uk='НКК'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Надбавка за квалификационную категорию';uk='Надбавка за кваліфікаційну категорію'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Квалиф. категория';uk='Кваліф. категорія'",Локализация.КодЯзыкаИнформационнойБазы());
...
Процедура СоздатьВнутрисменныеОтклонения(КоллекторНачислений, СвойстваНачислений, НастройкиРасчетаЗарплаты, ПараметрыПланаВидовРасчета)
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаКомандировки;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ЧСКМД';uk='ГДВДР'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Командировка (внутрисменная)';uk='Відрядження (внутрішньозмінне)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Командировка';uk='Відрядження'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.ФормулаРасчета			= "СреднийЗаработокОбщий * ВремяВЧасах";
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаПоСреднемуЗаработку;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ЧСДОНОР';uk='ГДДОНОР'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Оплата за дни сдачи крови и ее компонентов (внутрисменная)';uk='Оплата за дні здачі крові та її компонентів (внутрішньозмінна)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Донорство';uk='Донорство'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.ВидВремени 			= Перечисления.ВидыРабочегоВремениСотрудников.ЧасовоеНеотработанное;
	Описание.ОбозначениеВТабелеУчетаРабочегоВремени	= ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыИспользованияРабочегоВремени.ГосударственныеОбязанности");
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОтпускБезОплаты;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ЧСОЗ';uk='ГДВЗ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Отпуск без оплаты согласно КЗоТ (внутрисменный)';uk='Відпустка без оплати згідно КЗпП (внутрішньозмінна)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Отп. без опл.';uk='Відп. без опл.'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.ВидВремени 			= Перечисления.ВидыРабочегоВремениСотрудников.ЧасовоеНеотработанное;
	Описание.ОбозначениеВТабелеУчетаРабочегоВремени	= ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыИспользованияРабочегоВремени.НеоплачиваемыйОтпускПоЗаконодательству");
	Описание.ВидОтпуска = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыОтпусков.ОтпускЗаСвойСчетПоСоглашению");
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОтпускБезОплаты;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ЧСДО';uk='ГДДВ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Отпуск за свой счет (внутрисменный)';uk='Відпустка за свій рахунок (внутрішньозмінна)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Отп. за свой счет';uk='Відп. за свій рахунок'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.ВидВремени 			= Перечисления.ВидыРабочегоВремениСотрудников.ЧасовоеНеотработанное;
	Описание.ОбозначениеВТабелеУчетаРабочегоВремени	= ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыИспользованияРабочегоВремени.НеоплачиваемыйОтпускПоРазрешениюРаботодателя");
	Описание.ВидОтпуска = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыОтпусков.ОтпускЗаСвойСчет");
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОтпускБезОплаты;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ЧСУД';uk='ГДНД'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Дополнительный учебный отпуск без оплаты (внутрисменный)';uk='Додаткова навчальна відпустка без оплати (внутрішньозмінна)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Учебн. отп. без опл';uk='Навч. відп. без опл'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.ВидВремени 			= Перечисления.ВидыРабочегоВремениСотрудников.ЧасовоеНеотработанное;
	Описание.ОбозначениеВТабелеУчетаРабочегоВремени	= ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыИспользованияРабочегоВремени.ОтпускНаОбучениеНеоплачиваемый");
	Описание.ВидОтпуска = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыОтпусков.ОтпускБезОплатыУчебный");
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.НеявкаПоНевыясненнымПричинам;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ЧСНВХ';uk='ГДНВХ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Отсутствие по невыясненной причине (внутрисменное)';uk='Відсутність з нез''ясованих причин (внутрішньозмінна)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Неявка';uk='Неявка'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.ВидВремени 			= Перечисления.ВидыРабочегоВремениСотрудников.ЧасовоеНеотработанное;
	Описание.ОбозначениеВТабелеУчетаРабочегоВремени	= ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыИспользованияРабочегоВремени.НеявкиПоНевыясненнымПричинам");
	Описание.КлючевыеСвойства		= "ВидВремени,ОбозначениеВТабелеУчетаРабочегоВремени";
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.Прогул;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ЧСПРГ';uk='ГДПРГ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Внутрисменный прогул';uk='Внутрішньозмінний прогул'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Прогул';uk='Прогул'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.ВидВремени 			= Перечисления.ВидыРабочегоВремениСотрудников.ЧасовоеНеотработанное;
	Описание.ОбозначениеВТабелеУчетаРабочегоВремени	= ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыИспользованияРабочегоВремени.Прогулы");
	Описание.КлючевыеСвойства		= "ВидВремени,ОбозначениеВТабелеУчетаРабочегоВремени";
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПростойПоВинеРаботника;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ПРВРЧ';uk='ПРВРЧ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Внутрисменный простой по вине работника';uk='Внутрішньозмінний простій з вини працівника'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Простой без опл.';uk='Простій без опл.'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.ВидВремени 			= Перечисления.ВидыРабочегоВремениСотрудников.ЧасовоеНеотработанное;
	Описание.КлючевыеСвойства		= "ВидВремени";
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаПростояПоНезависящимОтРаботодателяПричинам;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ЧСПРО';uk='ГДПРО'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Оплата внутрисменного простоя по независящим от работодателя причинам';uk='Оплата внутрішньозмінного простою з незалежних від роботодавця причин'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Простой незав. прич.';uk='Простій незал. обстав.'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.ФормулаРасчета 		= "СреднийЗаработокОбщий * ВремяВЧасах";
	Описание.ВидВремени 			= Перечисления.ВидыРабочегоВремениСотрудников.ЧасовоеНеотработанное;
	Описание.ВидДокументаНачисления = Перечисления.ВидыДокументовНачисления.ПростойСотрудников;
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаПростояПоВинеРаботодателя;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ПРСРЧ';uk='ПРСРЧ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Оплата внутрисменного простоя по вине работодателя';uk='Оплата внутрішньозмінного простою з вини роботодавця'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Простой по вине работод.';uk='Простій з вини роботод.'",Локализация.КодЯзыкаИнформационнойБазы());
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.Отгул;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='ОТГВС';uk='ВДГВЗ'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Отгул (внутрисменный)';uk='Відгул (внутрішньозмінний)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Отгул (внутрисменный)';uk='Відгул (внутрішньозмінний)'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.ВидВремени 			= Перечисления.ВидыРабочегоВремениСотрудников.ЧасовоеНеотработанное;
	Описание.ОбозначениеВТабелеУчетаРабочегоВремени	= ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыИспользованияРабочегоВремени.ДругиеНеявкиПоКолДоговору");
	Описание.КлючевыеСвойства = "ВидВремени,КатегорияНачисленияИлиНеоплаченногоВремени";
...
Процедура СоздатьНачислениеДниОплаченныеДоНачалаЭксплуатации(ПараметрыПланаВидовРасчета, КоллекторНачислений = Неопределено, КоллекторУдержаний = Неопределено, СвойстваНачислений = Неопределено) Экспорт 
	...
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru='УЧТДН';uk='ВРХДП'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.Наименование			= НСтр("ru='Дни, учтенные до начала эксплуатации';uk='Дні, враховані до початку експлуатації'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.КраткоеНаименование 	= НСтр("ru='Дни, уже учтенные ранее';uk='Дні, вже враховані раніше'",Локализация.КодЯзыкаИнформационнойБазы());
	Описание.ВидВремени 			= Перечисления.ВидыРабочегоВремениСотрудников.ЦелодневноеНеотработанное;
	Описание.КлючевыеСвойства 							= "КатегорияНачисленияИлиНеоплаченногоВремени";
	СоздатьИзменитьНачисленияПоОписанию(КоллекторНачислений, Описание,,ПараметрыПланаВидовРасчета.НачальнаяНастройкаПрограммы);
