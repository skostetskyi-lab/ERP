...
Функция ТекстВопросаУдалитьВсеДатыЗапретаКромеДатДляВсехПользователей()
	...
	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Удалить все даты запрета, кроме установленных %1?';uk='Вилучити усі дати заборони, крім встановлених %1?'"),
		ЗначениеДляВсехПользователей);
...
Функция ТекстВопросаУдалитьВсеДатыЗапрета()
	...
	Возврат НСтр("ru='Удалить все даты запрета?';uk='Вилучити усі дати заборони?'");
