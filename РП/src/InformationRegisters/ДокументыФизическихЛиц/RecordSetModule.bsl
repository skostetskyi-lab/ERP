...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	Для Каждого Запись Из ЭтотОбъект Цикл
		...
		Иначе
			Запись.Представление = РегистрыСведений.ДокументыФизическихЛиц.ПолучитьПредставление(Запись.ВидДокумента, Запись.Серия, Запись.Номер, Запись.ДатаВыдачи, Запись.СрокДействия, Запись.КемВыдан, Запись.ДатаВремяФормирования);
