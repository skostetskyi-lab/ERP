...
Функция ПолучитьПредставление(ВидДокумента, Серия, Номер, ДатаВыдачи, СрокДействия, КемВыдан, ДатаВремяФормирования = "") Экспорт	
	...
	Возврат ""  + ВидДокумента
				...
				+ ?(ЗначениеЗаполнено(ДатаВремяФормирования), СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(", сформовано: %1", Формат(ДатаВремяФормирования,"ДФ='dd.MM.yyyy, HH:mm'")), "")
