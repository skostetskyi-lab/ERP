...
Процедура УдалитьДокументы(ТаблицаДокументы) Экспорт
	...
	//++ НЕ УТ
	ИменаОбъектовМетаданных = ИменаОбъектовМетаданных + ",Документ.ЗаказПереработчику";
	//-- НЕ УТ
	//++ НЕ УТКА
	ИменаОбъектовМетаданных = ИменаОбъектовМетаданных + ",Документ.ЗаказНаПроизводство";
	//-- НЕ УТКА
