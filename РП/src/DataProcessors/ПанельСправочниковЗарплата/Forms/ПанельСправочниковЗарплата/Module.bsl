...
//++ ЕРП ЗИК
//~	Элементы.ДекорацияВидыРаботСотрудников.Заголовок = НСтр("ru='Используется при вводе данных о выполненных работах для сдельного заработка.';uk='Використовується при введенні даних про виконані роботи для відрядного заробітку.'");
//-- ЕРП ЗИК	
