...
Процедура ВыгрузитьДвижения(Команда)
	...
	Пока ТекущийМесяц < КонецРасчета Цикл
		...
		ТекстСостояния = НСтр("ru='Выгружаем движения за %Месяц';uk='Вивантажуємо рухи за %Месяц'");
...
Процедура ЗаполнитьСписокРегистров()
	...
	//++ НЕ УТ
	СтрокаРегистр = ТаблицаРегистров.Добавить();
	СтрокаРегистр.ИмяРегистра = Метаданные.РегистрыНакопления.ТрудозатратыНезавершенногоПроизводства.ПолноеИмя();
	
	СтрокаРегистр = ТаблицаРегистров.Добавить();
	СтрокаРегистр.ИмяРегистра = Метаданные.РегистрыНакопления.ПартииНезавершенногоПроизводства.ПолноеИмя();
	
	СтрокаРегистр = ТаблицаРегистров.Добавить();
	СтрокаРегистр.ИмяРегистра = Метаданные.РегистрыНакопления.ПрочиеРасходыНезавершенногоПроизводства.ПолноеИмя();
	
	СтрокаРегистр = ТаблицаРегистров.Добавить();
	СтрокаРегистр.ИмяРегистра = Метаданные.РегистрыНакопления.МатериалыИРаботыВПроизводстве.ПолноеИмя();
	//-- НЕ УТ
