...
Процедура ВывестиШапку(ТабличныйДокумент, ОбластьШапка, РеквизитыДокумента, КадровыеДанныеСотрудника, РасчетныеМесяцы, КодЯзыкаПечать)
	...
	ЗначенияПараметров.Вставить("СинонимДокумента", 			Формат(Локализация.ПолучитьЛокализованныйСинонимОбъекта(РеквизитыДокумента.Ссылка, КодЯзыкаПечать), "Л="+КодЯзыкаПечать));
	...
	ЗначенияПараметров.Вставить("ВидЗанятости", 				?(ЗначениеЗаполнено(КадровыеДанныеСотрудника.ВидЗанятости),Локализация.ПолучитьЛокализованныйСинонимОбъекта(КадровыеДанныеСотрудника.ВидЗанятости,КодЯзыкаПечать),""));
