...
Процедура ВыполнитьВыгрузкуДанныхВКлиентСерверномРежиме(ИмяПланаОбмена,
	...
	ФоновоеЗадание = ФоновыеЗадания.Выполнить("ОбменДаннымиСервер.ВыполнитьВыгрузкуДляУзлаИнформационнойБазыВСервисПередачиФайлов",
										Параметры,
										КлючФоновогоЗадания,
										НСтр("ru='Выполнение обмена данными через веб-сервис.';uk='Виконання обміну даними через вебсервіс.'"));
	...
	Если ФоновоеЗадание.Состояние <> СостояниеФоновогоЗадания.Завершено Тогда
		...
		ВызватьИсключение НСтр("ru='Ошибка при выгрузке данных через веб-сервис.';uk='Помилка при вивантаженні даних через вебсервіс.'");
	КонецЕсли;
...
Процедура ВыполнитьЗагрузкуДанныхВКлиентСерверномРежиме(ИмяПланаОбмена,
	...
	Если ФоновоеЗадание.Состояние <> СостояниеФоновогоЗадания.Завершено Тогда
		...
		ВызватьИсключение НСтр("ru='Ошибка при загрузке данных через веб-сервис.';uk='Помилка при завантаженні даних через вебсервіс.'");
	КонецЕсли;
