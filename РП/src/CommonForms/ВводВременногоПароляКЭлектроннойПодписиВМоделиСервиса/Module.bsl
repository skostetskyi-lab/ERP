...
Процедура УправлениеФормой(Форма)
	...
	Если Форма.СпособДоставкиПаролей = "phone" Тогда
		Пояснение = НСтр("ru='На номер %1 отправлено SMS-сообщение с временным паролем.';uk='На номер %1 надіслано SMS-повідомлення з тимчасовим паролем.'");
	...
	ИначеЕсли Форма.СпособДоставкиПаролей = "email" Тогда
		Пояснение = НСтр("ru='На адрес %1 отправлено письмо с временным паролем.';uk='На адресу %1 відправлено лист з тимчасовим паролем.'");
