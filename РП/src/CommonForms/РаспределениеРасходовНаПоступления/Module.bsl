...
Процедура Распределить(Команда)
	...
	Если КоличествоСтрок = 1 Тогда                          
		 ТекстКоличествоСтрок = "" + КоличествоСтрок + НСтр("ru=' строку ';uk= ' рядок '");
	ИначеЕсли КоличествоСтрок > 1 И КоличествоСтрок < 5 Тогда
		ТекстКоличествоСтрок = "" + КоличествоСтрок + НСтр("ru=' строки ';uk= ' рядки '");
	Иначе
		ТекстКоличествоСтрок = "" + КоличествоСтрок + НСтр("ru=' строк ';uk= ' рядків '");
	КонецЕсли;
